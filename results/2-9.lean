...
/-
(Class II, Front Mode, with magic prime 271)   2 ^ x + 9 = 19 ^ y
For positive integers x, y satisfying 2 ^ x + 9 = 19 ^ y,
if y >= 1, 2 ^ x = 10 (mod 19).
So x = 17 (mod 18), 
which implies x = 8, 17, 26, 35, 44, 53, 62, 71, 80, 89, 98, 107, 116, 125, 134 (mod 135).
Therefore, 2 ^ x = 256, 179, 50, 126, 14, 122, 134, 45, 5, 121, 164, 229, 176, 140, 136 (mod 271).
So 19 ^ y = 265, 188, 59, 135, 23, 131, 143, 54, 14, 130, 173, 238, 185, 149, 145 (mod 271), but this is impossible.
Therefore, y < 1.
So 2 ^ x + 9 = 19 ^ y is impossible.
-/
theorem diophantine1_2_9_19 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 2 ^ x + 9 = 19 ^ y) :
  ...
  have h10 := Claim (List.Mem (2 ^ x % 271) [256, 179, 50, 126, 14, 122, 134, 45, 5, 121, 164, 229, 176, 140, 136]) [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := x % 18 = 17, proof := h9},
  ] "utilize_mod_cycle"
  have h11 := Claim (List.Mem (19 ^ y % 271) [265, 188, 59, 135, 23, 131, 143, 54, 14, 130, 173, 238, 185, 149, 145]) [
    {prop := List.Mem (2 ^ x % 271) [256, 179, 50, 126, 14, 122, 134, 45, 5, 121, 164, 229, 176, 140, 136], proof := h10},
    {prop := 2 ^ x + 9 = 19 ^ y, proof := h3},
  ] "compute_mod_add"
  have h12 := Claim False [
    {prop := y % 1 = 0, proof := h5},
    {prop := y >= 1, proof := h2},
    {prop := List.Mem (19 ^ y % 271) [265, 188, 59, 135, 23, 131, 143, 54, 14, 130, 173, 238, 185, 149, 145], proof := h11},
  ] "exhaust_mod_cycle"
  apply False.elim h12
  have h7 : y <= 0 := by omega
  have h8 := Claim False [
...
/-
(Class II, Back Mode, with magic prime 17)   2 ^ x + 9 = 25 ^ y
...
/-
(Class II, Front Mode, with magic prime 577)   2 ^ x + 9 = 37 ^ y
For positive integers x, y satisfying 2 ^ x + 9 = 37 ^ y,
if y >= 1, 2 ^ x = 28 (mod 37).
So x = 34 (mod 36), 
which implies x = 34, 70, 106, 142 (mod 144).
Therefore, 2 ^ x = 571, 144, 6, 433 (mod 577).
So 37 ^ y = 3, 153, 15, 442 (mod 577), but this is impossible.
Therefore, y < 1.
So 2 ^ x + 9 = 37 ^ y is impossible.
-/
theorem diophantine1_2_9_37 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 2 ^ x + 9 = 37 ^ y) :
  ...
  have h8 : 2 ^ x % 37 = 28 := by omega
  have h9 := Claim (x % 36 = 34) [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := 2 ^ x % 37 = 28, proof := h8},
  ] "observe_mod_cycle"
  have h10 := Claim (List.Mem (2 ^ x % 577) [571, 144, 6, 433]) [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := x % 36 = 34, proof := h9},
  ] "utilize_mod_cycle"
  have h11 := Claim (List.Mem (37 ^ y % 577) [3, 153, 15, 442]) [
    {prop := List.Mem (2 ^ x % 577) [571, 144, 6, 433], proof := h10},
    {prop := 2 ^ x + 9 = 37 ^ y, proof := h3},
  ] "compute_mod_add"
  have h12 := Claim False [
    {prop := y % 1 = 0, proof := h5},
    {prop := y >= 1, proof := h2},
    {prop := List.Mem (37 ^ y % 577) [3, 153, 15, 442], proof := h11},
  ] "exhaust_mod_cycle"
  apply False.elim h12
  have h7 : y <= 0 := by omega
  have h8 := Claim False [
...
/-
(Class II, Back Mode, no magic prime)   2 ^ x + 9 = 49 ^ y
For positive integers x, y satisfying 2 ^ x + 9 = 49 ^ y,
if x >= 4, 49 ^ y = 9 (mod 16).
However, this is impossible.
Therefore, x < 4.
Further examination shows that 2 ^ x + 9 = 49 ^ y is impossible.
-/
...
/-
(Class II, Front Mode, with magic prime 1741)   2 ^ x + 9 = 59 ^ y
For positive integers x, y satisfying 2 ^ x + 9 = 59 ^ y,
if y >= 1, 2 ^ x = 50 (mod 59).
So x = 13 (mod 58), 
which implies x = 13, 71, 129, 187, 245, 303, 361, 419, 477, 535, 593, 651, 709, 767, 825, 883, 941, 999, 1057, 1115, 1173, 1231, 1289, 1347, 1405, 1463, 1521, 1579, 1637, 1695 (mod 1740).
Therefore, 2 ^ x = 1228, 824, 1103, 1449, 1460, 1405, 1680, 305, 216, 661, 177, 856, 943, 508, 942, 513, 917, 638, 292, 281, 336, 61, 1436, 1525, 1080, 1564, 885, 798, 1233, 799 (mod 1741).
So 59 ^ y = 1237, 833, 1112, 1458, 1469, 1414, 1689, 314, 225, 670, 186, 865, 952, 517, 951, 522, 926, 647, 301, 290, 345, 70, 1445, 1534, 1089, 1573, 894, 807, 1242, 808 (mod 1741), but this is impossible.
Therefore, y < 1.
So 2 ^ x + 9 = 59 ^ y is impossible.
-/
theorem diophantine1_2_9_59 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 2 ^ x + 9 = 59 ^ y) :
  ...
  have h8 : 2 ^ x % 59 = 50 := by omega
  have h9 := Claim (x % 58 = 13) [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := 2 ^ x % 59 = 50, proof := h8},
  ] "observe_mod_cycle"
  have h10 := Claim (List.Mem (2 ^ x % 1741) [1228, 824, 1103, 1449, 1460, 1405, 1680, 305, 216, 661, 177, 856, 943, 508, 942, 513, 917, 638, 292, 281, 336, 61, 1436, 1525, 1080, 1564, 885, 798, 1233, 799]) [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := x % 58 = 13, proof := h9},
  ] "utilize_mod_cycle"
  have h11 := Claim (List.Mem (59 ^ y % 1741) [1237, 833, 1112, 1458, 1469, 1414, 1689, 314, 225, 670, 186, 865, 952, 517, 951, 522, 926, 647, 301, 290, 345, 70, 1445, 1534, 1089, 1573, 894, 807, 1242, 808]) [
    {prop := List.Mem (2 ^ x % 1741) [1228, 824, 1103, 1449, 1460, 1405, 1680, 305, 216, 661, 177, 856, 943, 508, 942, 513, 917, 638, 292, 281, 336, 61, 1436, 1525, 1080, 1564, 885, 798, 1233, 799], proof := h10},
    {prop := 2 ^ x + 9 = 59 ^ y, proof := h3},
  ] "compute_mod_add"
  have h12 := Claim False [
    {prop := y % 1 = 0, proof := h5},
    {prop := y >= 1, proof := h2},
    {prop := List.Mem (59 ^ y % 1741) [1237, 833, 1112, 1458, 1469, 1414, 1689, 314, 225, 670, 186, 865, 952, 517, 951, 522, 926, 647, 301, 290, 345, 70, 1445, 1534, 1089, 1573, 894, 807, 1242, 808], proof := h11},
  ] "exhaust_mod_cycle"
  apply False.elim h12
  have h7 : y <= 0 := by omega
  have h8 := Claim False [
...
/-
(Class II, Back Mode, with magic prime 337)   2 ^ x + 9 = 67 ^ y
For positive integers x, y satisfying 2 ^ x + 9 = 67 ^ y,
if x >= 6, 67 ^ y = 9 (mod 64).
So y = 2 (mod 16), 
which implies y = 2, 18, 34, 50, 66, 82, 98, 114, 130, 146, 162, 178, 194, 210, 226, 242, 258, 274, 290, 306, 322 (mod 336).
Therefore, 67 ^ y = 108, 216, 95, 190, 43, 86, 172, 7, 14, 28, 56, 112, 224, 111, 222, 107, 214, 91, 182, 27, 54 (mod 337).
So 2 ^ x = 99, 207, 86, 181, 34, 77, 163, 335, 5, 19, 47, 103, 215, 102, 213, 98, 205, 82, 173, 18, 45 (mod 337), but this is impossible.
Therefore, x < 6.
...
theorem diophantine1_2_9_67 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 2 ^ x + 9 = 67 ^ y) :
  ...
  have h10 := Claim (List.Mem (67 ^ y % 337) [108, 216, 95, 190, 43, 86, 172, 7, 14, 28, 56, 112, 224, 111, 222, 107, 214, 91, 182, 27, 54]) [
    {prop := y % 1 = 0, proof := h5},
    {prop := y >= 1, proof := h2},
    {prop := y % 16 = 2, proof := h9},
  ] "utilize_mod_cycle"
  have h11 := Claim (List.Mem (2 ^ x % 337) [99, 207, 86, 181, 34, 77, 163, 335, 5, 19, 47, 103, 215, 102, 213, 98, 205, 82, 173, 18, 45]) [
    {prop := List.Mem (67 ^ y % 337) [108, 216, 95, 190, 43, 86, 172, 7, 14, 28, 56, 112, 224, 111, 222, 107, 214, 91, 182, 27, 54], proof := h10},
    {prop := 2 ^ x + 9 = 67 ^ y, proof := h3},
  ] "compute_mod_sub"
  have h12 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := List.Mem (2 ^ x % 337) [99, 207, 86, 181, 34, 77, 163, 335, 5, 19, 47, 103, 215, 102, 213, 98, 205, 82, 173, 18, 45], proof := h11},
  ] "exhaust_mod_cycle"
  apply False.elim h12
  have h7 : x <= 5 := by omega
  have h8 := Claim False [
...
/-
(Class II, Back Mode, with magic prime 257)   2 ^ x + 9 = 101 ^ y
For positive integers x, y satisfying 2 ^ x + 9 = 101 ^ y,
if x >= 6, 101 ^ y = 9 (mod 64).
So y = 6 (mod 16), 
which implies y = 6, 22, 38, 54, 70, 86, 102, 118, 134, 150, 166, 182, 198, 214, 230, 246 (mod 256).
Therefore, 101 ^ y = 144, 226, 62, 133, 248, 18, 221, 72, 113, 31, 195, 124, 9, 239, 36, 185 (mod 257).
So 2 ^ x = 135, 217, 53, 124, 239, 9, 212, 63, 104, 22, 186, 115, 0, 230, 27, 176 (mod 257), but this is impossible.
Therefore, x < 6.
Further examination shows that 2 ^ x + 9 = 101 ^ y is impossible.
-/
theorem diophantine1_2_9_101 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 2 ^ x + 9 = 101 ^ y) :
  ...
  have h10 := Claim (List.Mem (101 ^ y % 257) [144, 226, 62, 133, 248, 18, 221, 72, 113, 31, 195, 124, 9, 239, 36, 185]) [
    {prop := y % 1 = 0, proof := h5},
    {prop := y >= 1, proof := h2},
    {prop := y % 16 = 6, proof := h9},
  ] "utilize_mod_cycle"
  have h11 := Claim (List.Mem (2 ^ x % 257) [135, 217, 53, 124, 239, 9, 212, 63, 104, 22, 186, 115, 0, 230, 27, 176]) [
    {prop := List.Mem (101 ^ y % 257) [144, 226, 62, 133, 248, 18, 221, 72, 113, 31, 195, 124, 9, 239, 36, 185], proof := h10},
    {prop := 2 ^ x + 9 = 101 ^ y, proof := h3},
  ] "compute_mod_sub"
  have h12 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := List.Mem (2 ^ x % 257) [135, 217, 53, 124, 239, 9, 212, 63, 104, 22, 186, 115, 0, 230, 27, 176], proof := h11},
  ] "exhaust_mod_cycle"
  apply False.elim h12
  have h7 : x <= 5 := by omega
  have h8 := Claim False [
...
/-
(Class II, Front Mode, with magic prime 661)   2 ^ x + 9 = 121 ^ y
For positive integers x, y satisfying 2 ^ x + 9 = 121 ^ y,
if y >= 2, 2 ^ x = 112 (mod 121).
So x = 11 (mod 110), 
which implies x = 11, 121, 231, 341, 451, 561 (mod 660).
Therefore, 2 ^ x = 65, 136, 71, 596, 525, 590 (mod 661).
So 121 ^ y = 74, 145, 80, 605, 534, 599 (mod 661), but this is impossible.
Therefore, y < 2.
Further examination shows that 2 ^ x + 9 = 121 ^ y is impossible.
-/
theorem diophantine1_2_9_121 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 2 ^ x + 9 = 121 ^ y) :
  ...
  have h8 : 2 ^ x % 121 = 112 := by omega
  have h9 := Claim (x % 110 = 11) [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := 2 ^ x % 121 = 112, proof := h8},
  ] "observe_mod_cycle"
  have h10 := Claim (List.Mem (2 ^ x % 661) [65, 136, 71, 596, 525, 590]) [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := x % 110 = 11, proof := h9},
  ] "utilize_mod_cycle"
  have h11 := Claim (List.Mem (121 ^ y % 661) [74, 145, 80, 605, 534, 599]) [
    {prop := List.Mem (2 ^ x % 661) [65, 136, 71, 596, 525, 590], proof := h10},
    {prop := 2 ^ x + 9 = 121 ^ y, proof := h3},
  ] "compute_mod_add"
  have h12 := Claim False [
    {prop := y % 1 = 0, proof := h5},
    {prop := y >= 1, proof := h2},
    {prop := List.Mem (121 ^ y % 661) [74, 145, 80, 605, 534, 599], proof := h11},
  ] "exhaust_mod_cycle"
  apply False.elim h12
  have h7 : y <= 1 := by omega
  have h8 := Claim False [
...
/-
(Class II, Back Mode, with magic prime 17)   2 ^ x + 9 = 125 ^ y
...
/-
(Class II, Back Mode, with magic prime 17)   2 ^ x + 9 = 169 ^ y
...
So 2 ^ x = 7 (mod 17), but this is impossible.
Therefore, x < 7.
Further examination shows that 2 ^ x + 9 = 169 ^ y is impossible.
-/
...
/-
(Class II, Front Mode, with magic prime 41)   2 ^ x + 9 = 245 ^ y
...
Therefore, y < 2.
Further examination shows that 2 ^ x + 9 = 245 ^ y is impossible.
-/
