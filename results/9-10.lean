...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 19)   9 ^ x + 10 = 251 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 251 ^ y,
if x >= 4, 251 ^ y = 10 (mod 81).
So y = 8 (mod 18), 
which implies y = 8 (mod 9).
Therefore, 251 ^ y = 5 (mod 19).
So 9 ^ x = 14 (mod 19), but this is impossible.
Therefore, x < 4.
Further examination shows that 9 ^ x + 10 = 251 ^ y is impossible.
-/
theorem diophantine1_9_10_251 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 251 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h10 := Claim (List.Mem (251 ^ y % 19) [5]) [
    {prop := y % 1 = 0, proof := h5},
    {prop := y >= 1, proof := h2},
    {prop := y % 18 = 8, proof := h9},
  ] "utilize_mod_cycle"
  have h11 := Claim (List.Mem (9 ^ x % 19) [14]) [
    {prop := List.Mem (251 ^ y % 19) [5], proof := h10},
    {prop := 9 ^ x + 10 = 251 ^ y, proof := h3},
  ] "compute_mod_sub"
  have h12 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
...
/-
(Class I, Type i)   9 ^ x + 10 = 252 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 252 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_252 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 252 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Front Mode, with magic prime 67)   9 ^ x + 10 = 253 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 253 ^ y,
if y >= 1, 9 ^ x = 13 (mod 23).
So x = 8 (mod 11).
Therefore, 9 ^ x = 25 (mod 67).
So 253 ^ y = 35 (mod 67), but this is impossible.
Therefore, y < 1.
So 9 ^ x + 10 = 253 ^ y is impossible.
-/
theorem diophantine1_9_10_253 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 253 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h11 := Claim (List.Mem (253 ^ y % 67) [35]) [
    {prop := List.Mem (9 ^ x % 67) [25], proof := h10},
    {prop := 9 ^ x + 10 = 253 ^ y, proof := h3},
  ] "compute_mod_add"
  have h12 := Claim False [
    {prop := y % 1 = 0, proof := h5},
    {prop := y >= 1, proof := h2},
    {prop := List.Mem (253 ^ y % 67) [35], proof := h11},
  ] "exhaust_mod_cycle"
  apply False.elim h12
  have h7 : y <= 0 := by omega
  have h8 := Claim False [
...
/-
(Class I, Type i)   9 ^ x + 10 = 254 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 254 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_254 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 254 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 255 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 255 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 5).
-/
theorem diophantine1_9_10_255 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 255 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 256 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 256 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_256 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 256 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 109)   9 ^ x + 10 = 257 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 257 ^ y,
if x >= 3, 257 ^ y = 10 (mod 27).
So y = 12 (mod 18), 
which implies y = 12, 30, 48, 66, 84, 102 (mod 108).
Therefore, 257 ^ y = 38, 4, 75, 71, 105, 34 (mod 109).
So 9 ^ x = 28, 103, 65, 61, 95, 24 (mod 109), but this is impossible.
Therefore, x < 3.
Further examination shows that 9 ^ x + 10 = 257 ^ y is impossible.
-/
theorem diophantine1_9_10_257 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 257 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h11 := Claim (List.Mem (9 ^ x % 109) [28, 103, 65, 61, 95, 24]) [
    {prop := List.Mem (257 ^ y % 109) [38, 4, 75, 71, 105, 34], proof := h10},
    {prop := 9 ^ x + 10 = 257 ^ y, proof := h3},
  ] "compute_mod_sub"
  have h12 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := List.Mem (9 ^ x % 109) [28, 103, 65, 61, 95, 24], proof := h11},
  ] "exhaust_mod_cycle"
  apply False.elim h12
  have h7 : x <= 2 := by omega
  have h8 := Claim False [
...
/-
(Class I, Type i)   9 ^ x + 10 = 258 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 258 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_258 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 258 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Front Mode, no magic prime)   9 ^ x + 10 = 259 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 259 ^ y,
if y >= 1, 9 ^ x = 27 (mod 37).
However, this is impossible.
Therefore, y < 1.
So 9 ^ x + 10 = 259 ^ y is impossible.
-/
theorem diophantine1_9_10_259 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 259 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 259 ^ y, proof := h3},
    {prop := y <= 0, proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 260 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 260 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 10).
-/
theorem diophantine1_9_10_260 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 260 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   9 ^ x + 10 = 261 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 261 ^ y,
if x >= 2 and y >= 2,
10 = 0 (mod 81), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 9 ^ x + 10 = 261 ^ y is impossible.
-/
theorem diophantine1_9_10_261 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 261 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 261 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 262 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 262 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_262 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 262 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 109)   9 ^ x + 10 = 263 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 263 ^ y,
if x >= 3, 263 ^ y = 10 (mod 27).
So y = 6 (mod 18), 
which implies y = 0 (mod 3).
Therefore, 263 ^ y = 1 (mod 109).
So 9 ^ x = 100 (mod 109), but this is impossible.
Therefore, x < 3.
Further examination shows that 9 ^ x + 10 = 263 ^ y is impossible.
-/
theorem diophantine1_9_10_263 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 263 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h11 := Claim (List.Mem (9 ^ x % 109) [100]) [
    {prop := List.Mem (263 ^ y % 109) [1], proof := h10},
    {prop := 9 ^ x + 10 = 263 ^ y, proof := h3},
  ] "compute_mod_sub"
  have h12 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := List.Mem (9 ^ x % 109) [100], proof := h11},
  ] "exhaust_mod_cycle"
  apply False.elim h12
  have h7 : x <= 2 := by omega
  have h8 := Claim False [
...
/-
(Class I, Type i)   9 ^ x + 10 = 264 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 264 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_264 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 264 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 265 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 265 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 5).
-/
theorem diophantine1_9_10_265 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 265 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 266 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 266 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_266 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 266 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   9 ^ x + 10 = 267 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 267 ^ y,
if x >= 3 and y >= 3,
10 = 0 (mod 27), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 9 ^ x + 10 = 267 ^ y is impossible.
-/
theorem diophantine1_9_10_267 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 267 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 267 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 268 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 268 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_268 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 268 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, no magic prime)   9 ^ x + 10 = 269 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 269 ^ y,
if x >= 3, 269 ^ y = 10 (mod 27).
However, this is impossible.
Therefore, x < 3.
Further examination shows that 9 ^ x + 10 = 269 ^ y is impossible.
-/
theorem diophantine1_9_10_269 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 269 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 269 ^ y, proof := h3},
    {prop := x <= 2, proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 270 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 270 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 10).
-/
theorem diophantine1_9_10_270 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 270 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, no magic prime)   9 ^ x + 10 = 271 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 271 ^ y,
if x >= 3, 271 ^ y = 10 (mod 27).
However, this is impossible.
Therefore, x < 3.
Further examination shows that 9 ^ x + 10 = 271 ^ y is impossible.
-/
theorem diophantine1_9_10_271 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 271 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 271 ^ y, proof := h3},
    {prop := x <= 2, proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 272 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 272 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_272 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 272 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   9 ^ x + 10 = 273 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 273 ^ y,
if x >= 3 and y >= 3,
10 = 0 (mod 27), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 9 ^ x + 10 = 273 ^ y is impossible.
-/
theorem diophantine1_9_10_273 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 273 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 273 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 274 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 274 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_274 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 274 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 275 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 275 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 5).
-/
theorem diophantine1_9_10_275 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 275 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 276 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 276 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_276 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 276 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 271)   9 ^ x + 10 = 277 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 277 ^ y,
...
So 9 ^ x = 13, 25, 220, 69, 122, 238, 226, 31, 182, 129 (mod 271), but this is impossible.
Therefore, x < 4.
Further examination shows that 9 ^ x + 10 = 277 ^ y is impossible.
-/
theorem diophantine1_9_10_277 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 277 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h11 := Claim (List.Mem (9 ^ x % 271) [13, 25, 220, 69, 122, 238, 226, 31, 182, 129]) [
    {prop := List.Mem (277 ^ y % 271) [23, 35, 230, 79, 132, 248, 236, 41, 192, 139], proof := h10},
    {prop := 9 ^ x + 10 = 277 ^ y, proof := h3},
  ] "compute_mod_sub"
  have h12 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := List.Mem (9 ^ x % 271) [13, 25, 220, 69, 122, 238, 226, 31, 182, 129], proof := h11},
  ] "exhaust_mod_cycle"
  apply False.elim h12
  have h7 : x <= 3 := by omega
  have h8 := Claim False [
...
/-
(Class I, Type i)   9 ^ x + 10 = 278 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 278 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_278 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 278 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   9 ^ x + 10 = 279 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 279 ^ y,
if x >= 2 and y >= 2,
10 = 0 (mod 81), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 9 ^ x + 10 = 279 ^ y is impossible.
-/
theorem diophantine1_9_10_279 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 279 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 279 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 280 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 280 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 10).
-/
theorem diophantine1_9_10_280 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 280 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 37)   9 ^ x + 10 = 281 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 281 ^ y,
if x >= 3, 281 ^ y = 10 (mod 27).
So y = 6 (mod 18), 
which implies y = 6, 24 (mod 36).
Therefore, 281 ^ y = 27, 10 (mod 37).
So 9 ^ x = 17, 0 (mod 37), but this is impossible.
Therefore, x < 3.
Further examination shows that 9 ^ x + 10 = 281 ^ y is impossible.
-/
theorem diophantine1_9_10_281 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 281 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h11 := Claim (List.Mem (9 ^ x % 37) [17, 0]) [
    {prop := List.Mem (281 ^ y % 37) [27, 10], proof := h10},
    {prop := 9 ^ x + 10 = 281 ^ y, proof := h3},
  ] "compute_mod_sub"
  have h12 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := List.Mem (9 ^ x % 37) [17, 0], proof := h11},
  ] "exhaust_mod_cycle"
  apply False.elim h12
  have h7 : x <= 2 := by omega
  have h8 := Claim False [
...
/-
(Class I, Type i)   9 ^ x + 10 = 282 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 282 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_282 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 282 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 271)   9 ^ x + 10 = 283 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 283 ^ y,
if x >= 4, 283 ^ y = 10 (mod 81).
So y = 3 (mod 27), 
which implies y = 3, 30 (mod 54).
Therefore, 283 ^ y = 102, 169 (mod 271).
So 9 ^ x = 92, 159 (mod 271), but this is impossible.
Therefore, x < 4.
Further examination shows that 9 ^ x + 10 = 283 ^ y is impossible.
-/
theorem diophantine1_9_10_283 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 283 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h11 := Claim (List.Mem (9 ^ x % 271) [92, 159]) [
    {prop := List.Mem (283 ^ y % 271) [102, 169], proof := h10},
    {prop := 9 ^ x + 10 = 283 ^ y, proof := h3},
  ] "compute_mod_sub"
  have h12 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := List.Mem (9 ^ x % 271) [92, 159], proof := h11},
  ] "exhaust_mod_cycle"
  apply False.elim h12
  have h7 : x <= 3 := by omega
  have h8 := Claim False [
...
/-
(Class I, Type i)   9 ^ x + 10 = 284 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 284 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_284 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 284 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 285 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 285 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 5).
-/
theorem diophantine1_9_10_285 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 285 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 286 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 286 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_286 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 286 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Front Mode, no magic prime)   9 ^ x + 10 = 287 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 287 ^ y,
if y >= 1, 9 ^ x = 31 (mod 41).
However, this is impossible.
Therefore, y < 1.
So 9 ^ x + 10 = 287 ^ y is impossible.
-/
theorem diophantine1_9_10_287 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 287 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 : 9 ^ x % 41 = 31 := by omega
  have h9 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := 9 ^ x % 41 = 31, proof := h8},
  ] "observe_mod_cycle"
  apply False.elim h9
  have h7 : y <= 0 := by omega
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 287 ^ y, proof := h3},
    {prop := y <= 0, proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 288 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 288 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_288 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 288 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Front Mode, no magic prime)   9 ^ x + 10 = 289 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 289 ^ y,
if y >= 1, 9 ^ x = 7 (mod 17).
However, this is impossible.
Therefore, y < 1.
So 9 ^ x + 10 = 289 ^ y is impossible.
-/
theorem diophantine1_9_10_289 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 289 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 289 ^ y, proof := h3},
    {prop := y <= 0, proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 290 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 290 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 10).
-/
theorem diophantine1_9_10_290 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 290 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   9 ^ x + 10 = 291 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 291 ^ y,
if x >= 3 and y >= 3,
10 = 0 (mod 27), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 9 ^ x + 10 = 291 ^ y is impossible.
-/
theorem diophantine1_9_10_291 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 291 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 291 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 292 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 292 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_292 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 292 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 19)   9 ^ x + 10 = 293 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 293 ^ y,
...
So 9 ^ x = 10 (mod 19), but this is impossible.
Therefore, x < 3.
Further examination shows that 9 ^ x + 10 = 293 ^ y is impossible.
-/
theorem diophantine1_9_10_293 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 293 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 294 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 294 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_294 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 294 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 295 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 295 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 5).
-/
theorem diophantine1_9_10_295 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 295 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 296 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 296 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_296 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 296 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   9 ^ x + 10 = 297 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 297 ^ y,
if x >= 2 and y >= 2,
10 = 0 (mod 81), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 9 ^ x + 10 = 297 ^ y is impossible.
-/
theorem diophantine1_9_10_297 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 297 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 297 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 298 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 298 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_298 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 298 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 109)   9 ^ x + 10 = 299 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 299 ^ y,
if x >= 3, 299 ^ y = 10 (mod 27).
So y = 6 (mod 18), 
which implies y = 6, 15, 24 (mod 27).
Therefore, 299 ^ y = 105, 75, 38 (mod 109).
So 9 ^ x = 95, 65, 28 (mod 109), but this is impossible.
Therefore, x < 3.
Further examination shows that 9 ^ x + 10 = 299 ^ y is impossible.
-/
theorem diophantine1_9_10_299 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 299 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h11 := Claim (List.Mem (9 ^ x % 109) [95, 65, 28]) [
    {prop := List.Mem (299 ^ y % 109) [105, 75, 38], proof := h10},
    {prop := 9 ^ x + 10 = 299 ^ y, proof := h3},
  ] "compute_mod_sub"
  have h12 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := List.Mem (9 ^ x % 109) [95, 65, 28], proof := h11},
  ] "exhaust_mod_cycle"
  apply False.elim h12
  have h7 : x <= 2 := by omega
  have h8 := Claim False [
...
/-
(Class I, Type i)   9 ^ x + 10 = 300 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 300 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 10).
-/
theorem diophantine1_9_10_300 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 300 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Front Mode, no magic prime)   9 ^ x + 10 = 301 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 301 ^ y,
if y >= 1, 9 ^ x = 33 (mod 43).
However, this is impossible.
Therefore, y < 1.
So 9 ^ x + 10 = 301 ^ y is impossible.
-/
theorem diophantine1_9_10_301 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 301 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 301 ^ y, proof := h3},
    {prop := y <= 0, proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 302 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 302 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_302 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 302 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   9 ^ x + 10 = 303 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 303 ^ y,
if x >= 3 and y >= 3,
10 = 0 (mod 27), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 9 ^ x + 10 = 303 ^ y is impossible.
-/
theorem diophantine1_9_10_303 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 303 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 303 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 304 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 304 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_304 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 304 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 305 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 305 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 5).
-/
theorem diophantine1_9_10_305 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 305 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 306 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 306 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_306 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 306 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 109)   9 ^ x + 10 = 307 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 307 ^ y,
if x >= 5, 307 ^ y = 10 (mod 243).
So y = 4 (mod 27), 
Therefore, 307 ^ y = 97 (mod 109).
So 9 ^ x = 87 (mod 109), but this is impossible.
Therefore, x < 5.
Further examination shows that 9 ^ x + 10 = 307 ^ y is impossible.
-/
theorem diophantine1_9_10_307 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 307 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h11 := Claim (List.Mem (9 ^ x % 109) [87]) [
    {prop := List.Mem (307 ^ y % 109) [97], proof := h10},
    {prop := 9 ^ x + 10 = 307 ^ y, proof := h3},
  ] "compute_mod_sub"
  have h12 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := List.Mem (9 ^ x % 109) [87], proof := h11},
  ] "exhaust_mod_cycle"
  apply False.elim h12
...
/-
(Class I, Type i)   9 ^ x + 10 = 308 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 308 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_308 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 308 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   9 ^ x + 10 = 309 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 309 ^ y,
if x >= 3 and y >= 3,
10 = 0 (mod 27), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 9 ^ x + 10 = 309 ^ y is impossible.
-/
theorem diophantine1_9_10_309 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 309 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 309 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 310 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 310 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 10).
-/
theorem diophantine1_9_10_310 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 310 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 19)   9 ^ x + 10 = 311 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 311 ^ y,
...
So 9 ^ x = 10 (mod 19), but this is impossible.
Therefore, x < 3.
Further examination shows that 9 ^ x + 10 = 311 ^ y is impossible.
-/
theorem diophantine1_9_10_311 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 311 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 312 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 312 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_312 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 312 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 271)   9 ^ x + 10 = 313 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 313 ^ y,
if x >= 4, 313 ^ y = 10 (mod 81).
So y = 6 (mod 27), 
which implies y = 6, 33, 60, 87, 114, 141, 168, 195, 222, 249 (mod 270).
Therefore, 313 ^ y = 185, 117, 178, 199, 224, 86, 154, 93, 72, 47 (mod 271).
So 9 ^ x = 175, 107, 168, 189, 214, 76, 144, 83, 62, 37 (mod 271), but this is impossible.
Therefore, x < 4.
Further examination shows that 9 ^ x + 10 = 313 ^ y is impossible.
-/
theorem diophantine1_9_10_313 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 313 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h10 := Claim (List.Mem (313 ^ y % 271) [185, 117, 178, 199, 224, 86, 154, 93, 72, 47]) [
    {prop := y % 1 = 0, proof := h5},
    {prop := y >= 1, proof := h2},
    {prop := y % 27 = 6, proof := h9},
  ] "utilize_mod_cycle"
  have h11 := Claim (List.Mem (9 ^ x % 271) [175, 107, 168, 189, 214, 76, 144, 83, 62, 37]) [
    {prop := List.Mem (313 ^ y % 271) [185, 117, 178, 199, 224, 86, 154, 93, 72, 47], proof := h10},
    {prop := 9 ^ x + 10 = 313 ^ y, proof := h3},
  ] "compute_mod_sub"
  have h12 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := List.Mem (9 ^ x % 271) [175, 107, 168, 189, 214, 76, 144, 83, 62, 37], proof := h11},
  ] "exhaust_mod_cycle"
  apply False.elim h12
  have h7 : x <= 3 := by omega
  have h8 := Claim False [
...
/-
(Class I, Type i)   9 ^ x + 10 = 314 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 314 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_314 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 314 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 315 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 315 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 5).
-/
theorem diophantine1_9_10_315 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 315 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 316 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 316 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_316 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 316 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 37)   9 ^ x + 10 = 317 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 317 ^ y,
if x >= 3, 317 ^ y = 10 (mod 27).
So y = 6 (mod 18), 
Therefore, 317 ^ y = 10 (mod 37).
So 9 ^ x = 0 (mod 37), but this is impossible.
Therefore, x < 3.
Further examination shows that 9 ^ x + 10 = 317 ^ y is impossible.
-/
theorem diophantine1_9_10_317 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 317 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 318 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 318 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_318 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 318 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Front Mode, no magic prime)   9 ^ x + 10 = 319 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 319 ^ y,
if y >= 1, 9 ^ x = 19 (mod 29).
However, this is impossible.
Therefore, y < 1.
So 9 ^ x + 10 = 319 ^ y is impossible.
-/
theorem diophantine1_9_10_319 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 319 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 : 9 ^ x % 29 = 19 := by omega
  have h9 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := 9 ^ x % 29 = 19, proof := h8},
  ] "observe_mod_cycle"
  apply False.elim h9
  have h7 : y <= 0 := by omega
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 319 ^ y, proof := h3},
    {prop := y <= 0, proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 320 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 320 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 10).
-/
theorem diophantine1_9_10_320 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 320 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   9 ^ x + 10 = 321 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 321 ^ y,
if x >= 3 and y >= 3,
10 = 0 (mod 27), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 9 ^ x + 10 = 321 ^ y is impossible.
-/
theorem diophantine1_9_10_321 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 321 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 321 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 322 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 322 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_322 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 322 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Front Mode, no magic prime)   9 ^ x + 10 = 323 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 323 ^ y,
if y >= 1, 9 ^ x = 7 (mod 17).
However, this is impossible.
Therefore, y < 1.
So 9 ^ x + 10 = 323 ^ y is impossible.
-/
theorem diophantine1_9_10_323 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 323 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 323 ^ y, proof := h3},
    {prop := y <= 0, proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 324 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 324 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_324 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 324 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 325 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 325 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 5).
-/
theorem diophantine1_9_10_325 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 325 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 326 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 326 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_326 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 326 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   9 ^ x + 10 = 327 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 327 ^ y,
if x >= 3 and y >= 3,
10 = 0 (mod 27), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 9 ^ x + 10 = 327 ^ y is impossible.
-/
theorem diophantine1_9_10_327 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 327 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 327 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 328 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 328 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_328 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 328 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 37)   9 ^ x + 10 = 329 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 329 ^ y,
...
So 9 ^ x = 0 (mod 37), but this is impossible.
Therefore, x < 3.
Further examination shows that 9 ^ x + 10 = 329 ^ y is impossible.
-/
theorem diophantine1_9_10_329 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 329 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 330 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 330 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 10).
-/
theorem diophantine1_9_10_330 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 330 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 109)   9 ^ x + 10 = 331 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 331 ^ y,
if x >= 4, 331 ^ y = 10 (mod 81).
So y = 15 (mod 27), 
which implies y = 6, 15 (mod 18).
Therefore, 331 ^ y = 63, 46 (mod 109).
So 9 ^ x = 53, 36 (mod 109), but this is impossible.
Therefore, x < 4.
Further examination shows that 9 ^ x + 10 = 331 ^ y is impossible.
-/
theorem diophantine1_9_10_331 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 331 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h11 := Claim (List.Mem (9 ^ x % 109) [53, 36]) [
    {prop := List.Mem (331 ^ y % 109) [63, 46], proof := h10},
    {prop := 9 ^ x + 10 = 331 ^ y, proof := h3},
  ] "compute_mod_sub"
  have h12 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := List.Mem (9 ^ x % 109) [53, 36], proof := h11},
  ] "exhaust_mod_cycle"
  apply False.elim h12
  have h7 : x <= 3 := by omega
  have h8 := Claim False [
...
/-
(Class I, Type i)   9 ^ x + 10 = 332 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 332 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_332 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 332 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   9 ^ x + 10 = 333 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 333 ^ y,
if x >= 2 and y >= 2,
10 = 0 (mod 81), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 9 ^ x + 10 = 333 ^ y is impossible.
-/
theorem diophantine1_9_10_333 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 333 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 333 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 334 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 334 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_334 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 334 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 335 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 335 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 5).
-/
theorem diophantine1_9_10_335 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 335 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 336 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 336 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_336 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 336 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 271)   9 ^ x + 10 = 337 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 337 ^ y,
...
So 9 ^ x = 226, 238, 122, 69, 220, 25, 13, 129, 182, 31 (mod 271), but this is impossible.
Therefore, x < 4.
Further examination shows that 9 ^ x + 10 = 337 ^ y is impossible.
-/
theorem diophantine1_9_10_337 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 337 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h11 := Claim (List.Mem (9 ^ x % 271) [226, 238, 122, 69, 220, 25, 13, 129, 182, 31]) [
    {prop := List.Mem (337 ^ y % 271) [236, 248, 132, 79, 230, 35, 23, 139, 192, 41], proof := h10},
    {prop := 9 ^ x + 10 = 337 ^ y, proof := h3},
  ] "compute_mod_sub"
  have h12 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := List.Mem (9 ^ x % 271) [226, 238, 122, 69, 220, 25, 13, 129, 182, 31], proof := h11},
  ] "exhaust_mod_cycle"
  apply False.elim h12
  have h7 : x <= 3 := by omega
  have h8 := Claim False [
...
/-
(Class I, Type i)   9 ^ x + 10 = 338 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 338 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_338 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 338 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   9 ^ x + 10 = 339 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 339 ^ y,
if x >= 3 and y >= 3,
10 = 0 (mod 27), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 9 ^ x + 10 = 339 ^ y is impossible.
-/
theorem diophantine1_9_10_339 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 339 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 339 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 340 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 340 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 10).
-/
theorem diophantine1_9_10_340 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 340 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Front Mode, no magic prime)   9 ^ x + 10 = 341 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 341 ^ y,
if y >= 1, 9 ^ x = 21 (mod 31).
However, this is impossible.
Therefore, y < 1.
So 9 ^ x + 10 = 341 ^ y is impossible.
-/
theorem diophantine1_9_10_341 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 341 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 341 ^ y, proof := h3},
    {prop := y <= 0, proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 342 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 342 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_342 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 342 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Front Mode, with magic prime 43)   9 ^ x + 10 = 343 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 343 ^ y,
if y >= 2, 9 ^ x = 39 (mod 49).
So x = 17 (mod 21).
Therefore, 9 ^ x = 31 (mod 43).
So 343 ^ y = 41 (mod 43), but this is impossible.
Therefore, y < 2.
Further examination shows that 9 ^ x + 10 = 343 ^ y is impossible.
-/
theorem diophantine1_9_10_343 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 343 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 344 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 344 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_344 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 344 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 345 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 345 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 5).
-/
theorem diophantine1_9_10_345 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 345 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 346 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 346 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_346 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 346 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 73)   9 ^ x + 10 = 347 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 347 ^ y,
if x >= 3, 347 ^ y = 10 (mod 27).
So y = 12 (mod 18), 
which implies y = 3 (mod 9).
Therefore, 347 ^ y = 8 (mod 73).
So 9 ^ x = 71 (mod 73), but this is impossible.
Therefore, x < 3.
Further examination shows that 9 ^ x + 10 = 347 ^ y is impossible.
-/
theorem diophantine1_9_10_347 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 347 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h11 := Claim (List.Mem (9 ^ x % 73) [71]) [
    {prop := List.Mem (347 ^ y % 73) [8], proof := h10},
    {prop := 9 ^ x + 10 = 347 ^ y, proof := h3},
  ] "compute_mod_sub"
  have h12 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := List.Mem (9 ^ x % 73) [71], proof := h11},
  ] "exhaust_mod_cycle"
  apply False.elim h12
  have h7 : x <= 2 := by omega
  have h8 := Claim False [
...
/-
(Class I, Type i)   9 ^ x + 10 = 348 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 348 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_348 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 348 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 109)   9 ^ x + 10 = 349 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 349 ^ y,
if x >= 4, 349 ^ y = 10 (mod 81).
So y = 24 (mod 27), 
Therefore, 349 ^ y = 16 (mod 109).
So 9 ^ x = 6 (mod 109), but this is impossible.
Therefore, x < 4.
Further examination shows that 9 ^ x + 10 = 349 ^ y is impossible.
-/
theorem diophantine1_9_10_349 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 349 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h11 := Claim (List.Mem (9 ^ x % 109) [6]) [
    {prop := List.Mem (349 ^ y % 109) [16], proof := h10},
    {prop := 9 ^ x + 10 = 349 ^ y, proof := h3},
  ] "compute_mod_sub"
  have h12 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := List.Mem (9 ^ x % 109) [6], proof := h11},
  ] "exhaust_mod_cycle"
  apply False.elim h12
  have h7 : x <= 3 := by omega
  have h8 := Claim False [
...
/-
(Class I, Type i)   9 ^ x + 10 = 350 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 350 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 10).
-/
theorem diophantine1_9_10_350 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 350 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   9 ^ x + 10 = 351 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 351 ^ y,
if x >= 2 and y >= 2,
10 = 0 (mod 81), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 9 ^ x + 10 = 351 ^ y is impossible.
-/
theorem diophantine1_9_10_351 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 351 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 351 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 352 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 352 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_352 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 352 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 19)   9 ^ x + 10 = 353 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 353 ^ y,
...
So 9 ^ x = 10 (mod 19), but this is impossible.
Therefore, x < 3.
Further examination shows that 9 ^ x + 10 = 353 ^ y is impossible.
-/
theorem diophantine1_9_10_353 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 353 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 354 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 354 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_354 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 354 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 355 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 355 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 5).
-/
theorem diophantine1_9_10_355 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 355 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 356 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 356 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_356 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 356 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   9 ^ x + 10 = 357 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 357 ^ y,
if x >= 3 and y >= 3,
10 = 0 (mod 27), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 9 ^ x + 10 = 357 ^ y is impossible.
-/
theorem diophantine1_9_10_357 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 357 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 357 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 358 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 358 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_358 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 358 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 19)   9 ^ x + 10 = 359 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 359 ^ y,
if x >= 4, 359 ^ y = 10 (mod 81).
So y = 2 (mod 18), 
which implies y = 2 (mod 9).
Therefore, 359 ^ y = 4 (mod 19).
So 9 ^ x = 13 (mod 19), but this is impossible.
Therefore, x < 4.
Further examination shows that 9 ^ x + 10 = 359 ^ y is impossible.
-/
theorem diophantine1_9_10_359 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 359 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h10 := Claim (List.Mem (359 ^ y % 19) [4]) [
    {prop := y % 1 = 0, proof := h5},
    {prop := y >= 1, proof := h2},
    {prop := y % 18 = 2, proof := h9},
  ] "utilize_mod_cycle"
  have h11 := Claim (List.Mem (9 ^ x % 19) [13]) [
    {prop := List.Mem (359 ^ y % 19) [4], proof := h10},
    {prop := 9 ^ x + 10 = 359 ^ y, proof := h3},
  ] "compute_mod_sub"
  have h12 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
...
/-
(Class I, Type i)   9 ^ x + 10 = 360 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 360 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 10).
-/
theorem diophantine1_9_10_360 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 360 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 109)   9 ^ x + 10 = 361 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 361 ^ y,
if x >= 5, 361 ^ y = 10 (mod 243).
So y = 25 (mod 27), 
which implies y = 7, 16 (mod 18).
Therefore, 361 ^ y = 71, 38 (mod 109).
So 9 ^ x = 61, 28 (mod 109), but this is impossible.
Therefore, x < 5.
Further examination shows that 9 ^ x + 10 = 361 ^ y is impossible.
-/
theorem diophantine1_9_10_361 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 361 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 : 361 ^ y % 243 = 10 := by omega
  have h9 := Claim (y % 27 = 25) [
    {prop := y % 1 = 0, proof := h5},
    {prop := y >= 1, proof := h2},
    {prop := 361 ^ y % 243 = 10, proof := h8},
  ] "observe_mod_cycle"
  have h10 := Claim (List.Mem (361 ^ y % 109) [71, 38]) [
    {prop := y % 1 = 0, proof := h5},
    {prop := y >= 1, proof := h2},
    {prop := y % 27 = 25, proof := h9},
  ] "utilize_mod_cycle"
  have h11 := Claim (List.Mem (9 ^ x % 109) [61, 28]) [
    {prop := List.Mem (361 ^ y % 109) [71, 38], proof := h10},
    {prop := 9 ^ x + 10 = 361 ^ y, proof := h3},
  ] "compute_mod_sub"
  have h12 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := List.Mem (9 ^ x % 109) [61, 28], proof := h11},
  ] "exhaust_mod_cycle"
  apply False.elim h12
  have h7 : x <= 4 := by omega
  have h8 := Claim False [
...
/-
(Class I, Type i)   9 ^ x + 10 = 362 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 362 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_362 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 362 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   9 ^ x + 10 = 363 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 363 ^ y,
if x >= 3 and y >= 3,
10 = 0 (mod 27), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 9 ^ x + 10 = 363 ^ y is impossible.
-/
theorem diophantine1_9_10_363 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 363 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 363 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 364 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 364 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_364 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 364 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 365 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 365 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 5).
-/
theorem diophantine1_9_10_365 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 365 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 366 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 366 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_366 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 366 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 271)   9 ^ x + 10 = 367 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 367 ^ y,
if x >= 4, 367 ^ y = 10 (mod 81).
So y = 6 (mod 27), 
which implies y = 6, 33, 60, 87, 114, 141, 168, 195, 222, 249 (mod 270).
Therefore, 367 ^ y = 8, 191, 258, 130, 55, 263, 80, 13, 141, 216 (mod 271).
So 9 ^ x = 269, 181, 248, 120, 45, 253, 70, 3, 131, 206 (mod 271), but this is impossible.
Therefore, x < 4.
Further examination shows that 9 ^ x + 10 = 367 ^ y is impossible.
-/
theorem diophantine1_9_10_367 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 367 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h10 := Claim (List.Mem (367 ^ y % 271) [8, 191, 258, 130, 55, 263, 80, 13, 141, 216]) [
    {prop := y % 1 = 0, proof := h5},
    {prop := y >= 1, proof := h2},
    {prop := y % 27 = 6, proof := h9},
  ] "utilize_mod_cycle"
  have h11 := Claim (List.Mem (9 ^ x % 271) [269, 181, 248, 120, 45, 253, 70, 3, 131, 206]) [
    {prop := List.Mem (367 ^ y % 271) [8, 191, 258, 130, 55, 263, 80, 13, 141, 216], proof := h10},
    {prop := 9 ^ x + 10 = 367 ^ y, proof := h3},
  ] "compute_mod_sub"
  have h12 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := List.Mem (9 ^ x % 271) [269, 181, 248, 120, 45, 253, 70, 3, 131, 206], proof := h11},
  ] "exhaust_mod_cycle"
  apply False.elim h12
  have h7 : x <= 3 := by omega
  have h8 := Claim False [
...
/-
(Class I, Type i)   9 ^ x + 10 = 368 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 368 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_368 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 368 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   9 ^ x + 10 = 369 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 369 ^ y,
if x >= 2 and y >= 2,
10 = 0 (mod 81), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 9 ^ x + 10 = 369 ^ y is impossible.
-/
theorem diophantine1_9_10_369 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 369 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 369 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 370 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 370 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 10).
-/
theorem diophantine1_9_10_370 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 370 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 109)   9 ^ x + 10 = 371 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 371 ^ y,
if x >= 3, 371 ^ y = 10 (mod 27).
So y = 6 (mod 18), 
which implies y = 6, 24, 42, 60, 78, 96 (mod 108).
Therefore, 371 ^ y = 82, 66, 93, 27, 43, 16 (mod 109).
So 9 ^ x = 72, 56, 83, 17, 33, 6 (mod 109), but this is impossible.
Therefore, x < 3.
Further examination shows that 9 ^ x + 10 = 371 ^ y is impossible.
-/
theorem diophantine1_9_10_371 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 371 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h11 := Claim (List.Mem (9 ^ x % 109) [72, 56, 83, 17, 33, 6]) [
    {prop := List.Mem (371 ^ y % 109) [82, 66, 93, 27, 43, 16], proof := h10},
    {prop := 9 ^ x + 10 = 371 ^ y, proof := h3},
  ] "compute_mod_sub"
  have h12 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := List.Mem (9 ^ x % 109) [72, 56, 83, 17, 33, 6], proof := h11},
  ] "exhaust_mod_cycle"
  apply False.elim h12
  have h7 : x <= 2 := by omega
  have h8 := Claim False [
...
/-
(Class I, Type i)   9 ^ x + 10 = 372 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 372 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_372 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 372 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 109)   9 ^ x + 10 = 373 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 373 ^ y,
if x >= 4, 373 ^ y = 10 (mod 81).
So y = 21 (mod 27), 
which implies y = 0, 3 (mod 6).
Therefore, 373 ^ y = 1, 108 (mod 109).
So 9 ^ x = 100, 98 (mod 109), but this is impossible.
Therefore, x < 4.
Further examination shows that 9 ^ x + 10 = 373 ^ y is impossible.
-/
theorem diophantine1_9_10_373 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 373 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h11 := Claim (List.Mem (9 ^ x % 109) [100, 98]) [
    {prop := List.Mem (373 ^ y % 109) [1, 108], proof := h10},
    {prop := 9 ^ x + 10 = 373 ^ y, proof := h3},
  ] "compute_mod_sub"
  have h12 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := List.Mem (9 ^ x % 109) [100, 98], proof := h11},
  ] "exhaust_mod_cycle"
  apply False.elim h12
  have h7 : x <= 3 := by omega
  have h8 := Claim False [
...
/-
(Class I, Type i)   9 ^ x + 10 = 374 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 374 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_374 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 374 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 375 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 375 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 5).
-/
theorem diophantine1_9_10_375 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 375 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 376 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 376 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_376 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 376 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, no magic prime)   9 ^ x + 10 = 377 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 377 ^ y,
if x >= 3, 377 ^ y = 10 (mod 27).
However, this is impossible.
Therefore, x < 3.
Further examination shows that 9 ^ x + 10 = 377 ^ y is impossible.
-/
theorem diophantine1_9_10_377 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 377 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 377 ^ y, proof := h3},
    {prop := x <= 2, proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 378 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 378 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_378 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 378 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, no magic prime)   9 ^ x + 10 = 379 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 379 ^ y,
if x >= 3, 379 ^ y = 10 (mod 27).
However, this is impossible.
Therefore, x < 3.
Further examination shows that 9 ^ x + 10 = 379 ^ y is impossible.
-/
theorem diophantine1_9_10_379 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 379 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 379 ^ y, proof := h3},
    {prop := x <= 2, proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 380 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 380 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 10).
-/
theorem diophantine1_9_10_380 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 380 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   9 ^ x + 10 = 381 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 381 ^ y,
if x >= 3 and y >= 3,
10 = 0 (mod 27), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 9 ^ x + 10 = 381 ^ y is impossible.
-/
theorem diophantine1_9_10_381 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 381 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 381 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 382 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 382 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_382 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 382 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 37)   9 ^ x + 10 = 383 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 383 ^ y,
...
So 9 ^ x = 0, 17 (mod 37), but this is impossible.
Therefore, x < 3.
Further examination shows that 9 ^ x + 10 = 383 ^ y is impossible.
-/
theorem diophantine1_9_10_383 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 383 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 384 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 384 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_384 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 384 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 385 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 385 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 5).
-/
theorem diophantine1_9_10_385 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 385 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 386 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 386 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_386 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 386 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   9 ^ x + 10 = 387 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 387 ^ y,
if x >= 2 and y >= 2,
10 = 0 (mod 81), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 9 ^ x + 10 = 387 ^ y is impossible.
-/
theorem diophantine1_9_10_387 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 387 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 387 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 388 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 388 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_388 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 388 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 109)   9 ^ x + 10 = 389 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 389 ^ y,
...
So 9 ^ x = 72, 56, 83, 17, 33, 6 (mod 109), but this is impossible.
Therefore, x < 3.
Further examination shows that 9 ^ x + 10 = 389 ^ y is impossible.
-/
theorem diophantine1_9_10_389 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 389 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 390 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 390 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 10).
-/
theorem diophantine1_9_10_390 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 390 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Front Mode, no magic prime)   9 ^ x + 10 = 391 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 391 ^ y,
if y >= 1, 9 ^ x = 7 (mod 17).
However, this is impossible.
Therefore, y < 1.
So 9 ^ x + 10 = 391 ^ y is impossible.
-/
theorem diophantine1_9_10_391 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 391 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 391 ^ y, proof := h3},
    {prop := y <= 0, proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 392 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 392 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_392 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 392 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   9 ^ x + 10 = 393 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 393 ^ y,
if x >= 3 and y >= 3,
10 = 0 (mod 27), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 9 ^ x + 10 = 393 ^ y is impossible.
-/
theorem diophantine1_9_10_393 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 393 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 393 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 394 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 394 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_394 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 394 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 395 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 395 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 5).
-/
theorem diophantine1_9_10_395 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 395 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 396 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 396 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_396 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 396 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 271)   9 ^ x + 10 = 397 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 397 ^ y,
if x >= 5, 397 ^ y = 10 (mod 243).
So y = 17 (mod 27), 
Therefore, 397 ^ y = 217 (mod 271).
So 9 ^ x = 207 (mod 271), but this is impossible.
Therefore, x < 5.
Further examination shows that 9 ^ x + 10 = 397 ^ y is impossible.
-/
theorem diophantine1_9_10_397 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 397 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h11 := Claim (List.Mem (9 ^ x % 271) [207]) [
    {prop := List.Mem (397 ^ y % 271) [217], proof := h10},
    {prop := 9 ^ x + 10 = 397 ^ y, proof := h3},
  ] "compute_mod_sub"
  have h12 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := List.Mem (9 ^ x % 271) [207], proof := h11},
  ] "exhaust_mod_cycle"
  apply False.elim h12
  have h7 : x <= 4 := by omega
  have h8 := Claim False [
...
/-
(Class I, Type i)   9 ^ x + 10 = 398 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 398 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_398 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 398 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   9 ^ x + 10 = 399 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 399 ^ y,
if x >= 3 and y >= 3,
10 = 0 (mod 27), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 9 ^ x + 10 = 399 ^ y is impossible.
-/
theorem diophantine1_9_10_399 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 399 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 399 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 400 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 400 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 10).
-/
theorem diophantine1_9_10_400 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 400 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 73)   9 ^ x + 10 = 401 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 401 ^ y,
if x >= 3, 401 ^ y = 10 (mod 27).
So y = 12 (mod 18), 
Therefore, 401 ^ y = 64 (mod 73).
So 9 ^ x = 54 (mod 73), but this is impossible.
Therefore, x < 3.
Further examination shows that 9 ^ x + 10 = 401 ^ y is impossible.
-/
theorem diophantine1_9_10_401 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 401 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h11 := Claim (List.Mem (9 ^ x % 73) [54]) [
    {prop := List.Mem (401 ^ y % 73) [64], proof := h10},
    {prop := 9 ^ x + 10 = 401 ^ y, proof := h3},
  ] "compute_mod_sub"
  have h12 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := List.Mem (9 ^ x % 73) [54], proof := h11},
  ] "exhaust_mod_cycle"
  apply False.elim h12
  have h7 : x <= 2 := by omega
  have h8 := Claim False [
...
/-
(Class I, Type i)   9 ^ x + 10 = 402 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 402 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_402 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 402 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Front Mode, no magic prime)   9 ^ x + 10 = 403 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 403 ^ y,
if y >= 1, 9 ^ x = 21 (mod 31).
However, this is impossible.
Therefore, y < 1.
So 9 ^ x + 10 = 403 ^ y is impossible.
-/
theorem diophantine1_9_10_403 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 403 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 403 ^ y, proof := h3},
    {prop := y <= 0, proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 404 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 404 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_404 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 404 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 405 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 405 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 5).
-/
theorem diophantine1_9_10_405 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 405 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 406 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 406 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_406 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 406 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 19)   9 ^ x + 10 = 407 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 407 ^ y,
if x >= 3, 407 ^ y = 10 (mod 27).
So y = 6 (mod 18), 
which implies y = 0 (mod 6).
Therefore, 407 ^ y = 1 (mod 19).
So 9 ^ x = 10 (mod 19), but this is impossible.
Therefore, x < 3.
Further examination shows that 9 ^ x + 10 = 407 ^ y is impossible.
-/
theorem diophantine1_9_10_407 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 407 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h10 := Claim (List.Mem (407 ^ y % 19) [1]) [
    {prop := y % 1 = 0, proof := h5},
    {prop := y >= 1, proof := h2},
    {prop := y % 18 = 6, proof := h9},
  ] "utilize_mod_cycle"
  have h11 := Claim (List.Mem (9 ^ x % 19) [10]) [
    {prop := List.Mem (407 ^ y % 19) [1], proof := h10},
    {prop := 9 ^ x + 10 = 407 ^ y, proof := h3},
  ] "compute_mod_sub"
  have h12 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
...
/-
(Class I, Type i)   9 ^ x + 10 = 408 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 408 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_408 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 408 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 109)   9 ^ x + 10 = 409 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 409 ^ y,
if x >= 4, 409 ^ y = 10 (mod 81).
So y = 12 (mod 27), 
which implies y = 3, 12 (mod 18).
Therefore, 409 ^ y = 46, 63 (mod 109).
So 9 ^ x = 36, 53 (mod 109), but this is impossible.
Therefore, x < 4.
Further examination shows that 9 ^ x + 10 = 409 ^ y is impossible.
-/
theorem diophantine1_9_10_409 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 409 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h11 := Claim (List.Mem (9 ^ x % 109) [36, 53]) [
    {prop := List.Mem (409 ^ y % 109) [46, 63], proof := h10},
    {prop := 9 ^ x + 10 = 409 ^ y, proof := h3},
  ] "compute_mod_sub"
  have h12 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := List.Mem (9 ^ x % 109) [36, 53], proof := h11},
  ] "exhaust_mod_cycle"
  apply False.elim h12
  have h7 : x <= 3 := by omega
  have h8 := Claim False [
...
/-
(Class I, Type i)   9 ^ x + 10 = 410 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 410 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 10).
-/
theorem diophantine1_9_10_410 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 410 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   9 ^ x + 10 = 411 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 411 ^ y,
if x >= 3 and y >= 3,
10 = 0 (mod 27), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 9 ^ x + 10 = 411 ^ y is impossible.
-/
theorem diophantine1_9_10_411 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 411 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 411 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 412 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 412 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_412 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 412 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Front Mode, with magic prime 127)   9 ^ x + 10 = 413 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 413 ^ y,
if y >= 2, 9 ^ x = 39 (mod 49).
So x = 17 (mod 21), 
which implies x = 17, 38, 59 (mod 63).
Therefore, 9 ^ x = 30, 35, 62 (mod 127).
So 413 ^ y = 40, 45, 72 (mod 127), but this is impossible.
Therefore, y < 2.
Further examination shows that 9 ^ x + 10 = 413 ^ y is impossible.
-/
theorem diophantine1_9_10_413 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 413 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h10 := Claim (List.Mem (9 ^ x % 127) [30, 35, 62]) [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := x % 21 = 17, proof := h9},
  ] "utilize_mod_cycle"
  have h11 := Claim (List.Mem (413 ^ y % 127) [40, 45, 72]) [
    {prop := List.Mem (9 ^ x % 127) [30, 35, 62], proof := h10},
    {prop := 9 ^ x + 10 = 413 ^ y, proof := h3},
  ] "compute_mod_add"
  have h12 := Claim False [
    {prop := y % 1 = 0, proof := h5},
    {prop := y >= 1, proof := h2},
...
/-
(Class I, Type i)   9 ^ x + 10 = 414 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 414 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_414 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 414 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 415 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 415 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 5).
-/
theorem diophantine1_9_10_415 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 415 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 416 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 416 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_416 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 416 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   9 ^ x + 10 = 417 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 417 ^ y,
if x >= 3 and y >= 3,
10 = 0 (mod 27), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 9 ^ x + 10 = 417 ^ y is impossible.
-/
theorem diophantine1_9_10_417 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 417 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 417 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 418 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 418 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_418 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 418 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 73)   9 ^ x + 10 = 419 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 419 ^ y,
if x >= 3, 419 ^ y = 10 (mod 27).
So y = 12 (mod 18), 
which implies y = 12, 30 (mod 36).
Therefore, 419 ^ y = 8, 65 (mod 73).
So 9 ^ x = 71, 55 (mod 73), but this is impossible.
Therefore, x < 3.
Further examination shows that 9 ^ x + 10 = 419 ^ y is impossible.
-/
theorem diophantine1_9_10_419 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 419 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h11 := Claim (List.Mem (9 ^ x % 73) [71, 55]) [
    {prop := List.Mem (419 ^ y % 73) [8, 65], proof := h10},
    {prop := 9 ^ x + 10 = 419 ^ y, proof := h3},
  ] "compute_mod_sub"
  have h12 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := List.Mem (9 ^ x % 73) [71, 55], proof := h11},
  ] "exhaust_mod_cycle"
  apply False.elim h12
  have h7 : x <= 2 := by omega
  have h8 := Claim False [
...
/-
(Class I, Type i)   9 ^ x + 10 = 420 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 420 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 10).
-/
theorem diophantine1_9_10_420 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 420 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 109)   9 ^ x + 10 = 421 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 421 ^ y,
if x >= 4, 421 ^ y = 10 (mod 81).
So y = 6 (mod 27), 
which implies y = 6, 33 (mod 54).
Therefore, 421 ^ y = 16, 93 (mod 109).
So 9 ^ x = 6, 83 (mod 109), but this is impossible.
Therefore, x < 4.
Further examination shows that 9 ^ x + 10 = 421 ^ y is impossible.
-/
theorem diophantine1_9_10_421 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 421 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h11 := Claim (List.Mem (9 ^ x % 109) [6, 83]) [
    {prop := List.Mem (421 ^ y % 109) [16, 93], proof := h10},
    {prop := 9 ^ x + 10 = 421 ^ y, proof := h3},
  ] "compute_mod_sub"
  have h12 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := List.Mem (9 ^ x % 109) [6, 83], proof := h11},
  ] "exhaust_mod_cycle"
  apply False.elim h12
  have h7 : x <= 3 := by omega
  have h8 := Claim False [
...
/-
(Class I, Type i)   9 ^ x + 10 = 422 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 422 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_422 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 422 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   9 ^ x + 10 = 423 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 423 ^ y,
if x >= 2 and y >= 2,
10 = 0 (mod 81), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 9 ^ x + 10 = 423 ^ y is impossible.
-/
theorem diophantine1_9_10_423 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 423 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 423 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 424 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 424 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_424 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 424 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 425 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 425 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 5).
-/
theorem diophantine1_9_10_425 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 425 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 426 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 426 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_426 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 426 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Front Mode, with magic prime 463)   9 ^ x + 10 = 427 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 427 ^ y,
if y >= 2, 9 ^ x = 39 (mod 49).
So x = 17 (mod 21), 
which implies x = 17, 38, 59, 80, 101, 122, 143, 164, 185, 206, 227 (mod 231).
Therefore, 9 ^ x = 2, 316, 387, 30, 110, 249, 450, 261, 31, 268, 211 (mod 463).
So 427 ^ y = 12, 326, 397, 40, 120, 259, 460, 271, 41, 278, 221 (mod 463), but this is impossible.
Therefore, y < 2.
Further examination shows that 9 ^ x + 10 = 427 ^ y is impossible.
-/
theorem diophantine1_9_10_427 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 427 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h10 := Claim (List.Mem (9 ^ x % 463) [2, 316, 387, 30, 110, 249, 450, 261, 31, 268, 211]) [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := x % 21 = 17, proof := h9},
  ] "utilize_mod_cycle"
  have h11 := Claim (List.Mem (427 ^ y % 463) [12, 326, 397, 40, 120, 259, 460, 271, 41, 278, 221]) [
    {prop := List.Mem (9 ^ x % 463) [2, 316, 387, 30, 110, 249, 450, 261, 31, 268, 211], proof := h10},
    {prop := 9 ^ x + 10 = 427 ^ y, proof := h3},
  ] "compute_mod_add"
  have h12 := Claim False [
    {prop := y % 1 = 0, proof := h5},
    {prop := y >= 1, proof := h2},
...
/-
(Class I, Type i)   9 ^ x + 10 = 428 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 428 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_428 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 428 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   9 ^ x + 10 = 429 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 429 ^ y,
if x >= 3 and y >= 3,
10 = 0 (mod 27), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 9 ^ x + 10 = 429 ^ y is impossible.
-/
theorem diophantine1_9_10_429 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 429 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 429 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 430 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 430 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 10).
-/
theorem diophantine1_9_10_430 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 430 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, no magic prime)   9 ^ x + 10 = 431 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 431 ^ y,
if x >= 3, 431 ^ y = 10 (mod 27).
However, this is impossible.
Therefore, x < 3.
Further examination shows that 9 ^ x + 10 = 431 ^ y is impossible.
-/
theorem diophantine1_9_10_431 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 431 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 431 ^ y, proof := h3},
    {prop := x <= 2, proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 432 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 432 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_432 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 432 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, no magic prime)   9 ^ x + 10 = 433 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 433 ^ y,
if x >= 3, 433 ^ y = 10 (mod 27).
However, this is impossible.
Therefore, x < 3.
Further examination shows that 9 ^ x + 10 = 433 ^ y is impossible.
-/
theorem diophantine1_9_10_433 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 433 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 433 ^ y, proof := h3},
    {prop := x <= 2, proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 434 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 434 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_434 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 434 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 435 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 435 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 5).
-/
theorem diophantine1_9_10_435 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 435 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 436 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 436 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_436 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 436 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 37)   9 ^ x + 10 = 437 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 437 ^ y,
if x >= 3, 437 ^ y = 10 (mod 27).
So y = 12 (mod 18), 
Therefore, 437 ^ y = 10 (mod 37).
So 9 ^ x = 0 (mod 37), but this is impossible.
Therefore, x < 3.
Further examination shows that 9 ^ x + 10 = 437 ^ y is impossible.
-/
theorem diophantine1_9_10_437 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 437 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 : 437 ^ y % 27 = 10 := by omega
  have h9 := Claim (y % 18 = 12) [
    {prop := y % 1 = 0, proof := h5},
    {prop := y >= 1, proof := h2},
    {prop := 437 ^ y % 27 = 10, proof := h8},
  ] "observe_mod_cycle"
  have h10 := Claim (List.Mem (437 ^ y % 37) [10]) [
    {prop := y % 1 = 0, proof := h5},
    {prop := y >= 1, proof := h2},
    {prop := y % 18 = 12, proof := h9},
  ] "utilize_mod_cycle"
  have h11 := Claim (List.Mem (9 ^ x % 37) [0]) [
    {prop := List.Mem (437 ^ y % 37) [10], proof := h10},
    {prop := 9 ^ x + 10 = 437 ^ y, proof := h3},
  ] "compute_mod_sub"
  have h12 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
...
/-
(Class I, Type i)   9 ^ x + 10 = 438 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 438 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_438 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 438 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 109)   9 ^ x + 10 = 439 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 439 ^ y,
if x >= 4, 439 ^ y = 10 (mod 81).
So y = 15 (mod 27), 
Therefore, 439 ^ y = 38 (mod 109).
So 9 ^ x = 28 (mod 109), but this is impossible.
Therefore, x < 4.
Further examination shows that 9 ^ x + 10 = 439 ^ y is impossible.
-/
theorem diophantine1_9_10_439 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 439 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 440 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 440 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 10).
-/
theorem diophantine1_9_10_440 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 440 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   9 ^ x + 10 = 441 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 441 ^ y,
if x >= 2 and y >= 2,
10 = 0 (mod 81), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 9 ^ x + 10 = 441 ^ y is impossible.
-/
theorem diophantine1_9_10_441 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 441 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 441 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 442 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 442 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_442 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 442 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 37)   9 ^ x + 10 = 443 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 443 ^ y,
...
So 9 ^ x = 28 (mod 37), but this is impossible.
Therefore, x < 3.
Further examination shows that 9 ^ x + 10 = 443 ^ y is impossible.
-/
theorem diophantine1_9_10_443 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 443 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 444 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 444 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_444 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 444 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 445 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 445 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 5).
-/
theorem diophantine1_9_10_445 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 445 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 446 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 446 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_446 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 446 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   9 ^ x + 10 = 447 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 447 ^ y,
if x >= 3 and y >= 3,
10 = 0 (mod 27), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 9 ^ x + 10 = 447 ^ y is impossible.
-/
theorem diophantine1_9_10_447 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 447 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 447 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 448 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 448 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_448 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 448 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 37)   9 ^ x + 10 = 449 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 449 ^ y,
if x >= 4, 449 ^ y = 10 (mod 81).
So y = 16 (mod 18), 
which implies y = 16, 34 (mod 36).
Therefore, 449 ^ y = 34, 3 (mod 37).
So 9 ^ x = 24, 30 (mod 37), but this is impossible.
Therefore, x < 4.
Further examination shows that 9 ^ x + 10 = 449 ^ y is impossible.
-/
theorem diophantine1_9_10_449 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 449 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h10 := Claim (List.Mem (449 ^ y % 37) [34, 3]) [
    {prop := y % 1 = 0, proof := h5},
    {prop := y >= 1, proof := h2},
    {prop := y % 18 = 16, proof := h9},
  ] "utilize_mod_cycle"
  have h11 := Claim (List.Mem (9 ^ x % 37) [24, 30]) [
    {prop := List.Mem (449 ^ y % 37) [34, 3], proof := h10},
    {prop := 9 ^ x + 10 = 449 ^ y, proof := h3},
  ] "compute_mod_sub"
  have h12 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := List.Mem (9 ^ x % 37) [24, 30], proof := h11},
  ] "exhaust_mod_cycle"
  apply False.elim h12
  have h7 : x <= 3 := by omega
  have h8 := Claim False [
...
/-
(Class I, Type i)   9 ^ x + 10 = 450 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 450 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 10).
-/
theorem diophantine1_9_10_450 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 450 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Front Mode, no magic prime)   9 ^ x + 10 = 451 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 451 ^ y,
if y >= 1, 9 ^ x = 31 (mod 41).
However, this is impossible.
Therefore, y < 1.
So 9 ^ x + 10 = 451 ^ y is impossible.
-/
theorem diophantine1_9_10_451 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 451 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 451 ^ y, proof := h3},
    {prop := y <= 0, proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 452 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 452 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_452 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 452 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   9 ^ x + 10 = 453 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 453 ^ y,
if x >= 3 and y >= 3,
10 = 0 (mod 27), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 9 ^ x + 10 = 453 ^ y is impossible.
-/
theorem diophantine1_9_10_453 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 453 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 453 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 454 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 454 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_454 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 454 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 455 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 455 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 5).
-/
theorem diophantine1_9_10_455 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 455 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 456 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 456 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_456 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 456 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 109)   9 ^ x + 10 = 457 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 457 ^ y,
if x >= 4, 457 ^ y = 10 (mod 81).
So y = 24 (mod 27), 
Therefore, 457 ^ y = 27 (mod 109).
So 9 ^ x = 17 (mod 109), but this is impossible.
Therefore, x < 4.
Further examination shows that 9 ^ x + 10 = 457 ^ y is impossible.
-/
theorem diophantine1_9_10_457 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 457 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 458 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 458 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_458 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 458 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   9 ^ x + 10 = 459 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 459 ^ y,
if x >= 2 and y >= 2,
10 = 0 (mod 81), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 9 ^ x + 10 = 459 ^ y is impossible.
-/
theorem diophantine1_9_10_459 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 459 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 459 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 460 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 460 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 10).
-/
theorem diophantine1_9_10_460 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 460 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 37)   9 ^ x + 10 = 461 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 461 ^ y,
...
So 9 ^ x = 17, 0 (mod 37), but this is impossible.
Therefore, x < 3.
Further examination shows that 9 ^ x + 10 = 461 ^ y is impossible.
-/
theorem diophantine1_9_10_461 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 461 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 462 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 462 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_462 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 462 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 109)   9 ^ x + 10 = 463 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 463 ^ y,
if x >= 4, 463 ^ y = 10 (mod 81).
So y = 12 (mod 27), 
which implies y = 3 (mod 9).
Therefore, 463 ^ y = 63 (mod 109).
So 9 ^ x = 53 (mod 109), but this is impossible.
Therefore, x < 4.
Further examination shows that 9 ^ x + 10 = 463 ^ y is impossible.
-/
theorem diophantine1_9_10_463 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 463 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h11 := Claim (List.Mem (9 ^ x % 109) [53]) [
    {prop := List.Mem (463 ^ y % 109) [63], proof := h10},
    {prop := 9 ^ x + 10 = 463 ^ y, proof := h3},
  ] "compute_mod_sub"
  have h12 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := List.Mem (9 ^ x % 109) [53], proof := h11},
  ] "exhaust_mod_cycle"
  apply False.elim h12
  have h7 : x <= 3 := by omega
  have h8 := Claim False [
...
/-
(Class I, Type i)   9 ^ x + 10 = 464 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 464 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_464 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 464 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 465 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 465 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 5).
-/
theorem diophantine1_9_10_465 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 465 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 466 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 466 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_466 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 466 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 73)   9 ^ x + 10 = 467 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 467 ^ y,
if x >= 4, 467 ^ y = 10 (mod 81).
So y = 14 (mod 18), 
which implies y = 14, 32, 50, 68 (mod 72).
Therefore, 467 ^ y = 61, 32, 12, 41 (mod 73).
So 9 ^ x = 51, 22, 2, 31 (mod 73), but this is impossible.
Therefore, x < 4.
Further examination shows that 9 ^ x + 10 = 467 ^ y is impossible.
-/
theorem diophantine1_9_10_467 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 467 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h11 := Claim (List.Mem (9 ^ x % 73) [51, 22, 2, 31]) [
    {prop := List.Mem (467 ^ y % 73) [61, 32, 12, 41], proof := h10},
    {prop := 9 ^ x + 10 = 467 ^ y, proof := h3},
  ] "compute_mod_sub"
  have h12 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := List.Mem (9 ^ x % 73) [51, 22, 2, 31], proof := h11},
  ] "exhaust_mod_cycle"
  apply False.elim h12
  have h7 : x <= 3 := by omega
  have h8 := Claim False [
...
/-
(Class I, Type i)   9 ^ x + 10 = 468 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 468 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_468 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 468 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Front Mode, with magic prime 421)   9 ^ x + 10 = 469 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 469 ^ y,
if y >= 2, 9 ^ x = 39 (mod 49).
So x = 17 (mod 21), 
which implies x = 17, 38, 59, 80, 101 (mod 105).
Therefore, 9 ^ x = 147, 268, 417, 176, 255 (mod 421).
So 469 ^ y = 157, 278, 6, 186, 265 (mod 421), but this is impossible.
Therefore, y < 2.
Further examination shows that 9 ^ x + 10 = 469 ^ y is impossible.
-/
theorem diophantine1_9_10_469 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 469 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h10 := Claim (List.Mem (9 ^ x % 421) [147, 268, 417, 176, 255]) [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := x % 21 = 17, proof := h9},
  ] "utilize_mod_cycle"
  have h11 := Claim (List.Mem (469 ^ y % 421) [157, 278, 6, 186, 265]) [
    {prop := List.Mem (9 ^ x % 421) [147, 268, 417, 176, 255], proof := h10},
    {prop := 9 ^ x + 10 = 469 ^ y, proof := h3},
  ] "compute_mod_add"
  have h12 := Claim False [
    {prop := y % 1 = 0, proof := h5},
    {prop := y >= 1, proof := h2},
    {prop := List.Mem (469 ^ y % 421) [157, 278, 6, 186, 265], proof := h11},
  ] "exhaust_mod_cycle"
  apply False.elim h12
  have h7 : y <= 1 := by omega
  have h8 := Claim False [
...
/-
(Class I, Type i)   9 ^ x + 10 = 470 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 470 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 10).
-/
theorem diophantine1_9_10_470 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 470 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   9 ^ x + 10 = 471 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 471 ^ y,
if x >= 3 and y >= 3,
10 = 0 (mod 27), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 9 ^ x + 10 = 471 ^ y is impossible.
-/
theorem diophantine1_9_10_471 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 471 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 471 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 472 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 472 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_472 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 472 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 109)   9 ^ x + 10 = 473 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 473 ^ y,
if x >= 3, 473 ^ y = 10 (mod 27).
So y = 12 (mod 18), 
which implies y = 12, 30, 48, 66, 84, 102 (mod 108).
Therefore, 473 ^ y = 105, 34, 38, 4, 75, 71 (mod 109).
So 9 ^ x = 95, 24, 28, 103, 65, 61 (mod 109), but this is impossible.
Therefore, x < 3.
Further examination shows that 9 ^ x + 10 = 473 ^ y is impossible.
-/
theorem diophantine1_9_10_473 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 473 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h11 := Claim (List.Mem (9 ^ x % 109) [95, 24, 28, 103, 65, 61]) [
    {prop := List.Mem (473 ^ y % 109) [105, 34, 38, 4, 75, 71], proof := h10},
    {prop := 9 ^ x + 10 = 473 ^ y, proof := h3},
  ] "compute_mod_sub"
  have h12 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
    {prop := List.Mem (9 ^ x % 109) [95, 24, 28, 103, 65, 61], proof := h11},
  ] "exhaust_mod_cycle"
  apply False.elim h12
  have h7 : x <= 2 := by omega
  have h8 := Claim False [
...
/-
(Class I, Type i)   9 ^ x + 10 = 474 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 474 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_474 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 474 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 475 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 475 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 5).
-/
theorem diophantine1_9_10_475 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 475 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 476 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 476 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_476 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 476 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   9 ^ x + 10 = 477 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 477 ^ y,
if x >= 2 and y >= 2,
10 = 0 (mod 81), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 9 ^ x + 10 = 477 ^ y is impossible.
-/
theorem diophantine1_9_10_477 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 477 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 477 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 478 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 478 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_478 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 478 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 37)   9 ^ x + 10 = 479 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 479 ^ y,
...
So 9 ^ x = 17, 0 (mod 37), but this is impossible.
Therefore, x < 3.
Further examination shows that 9 ^ x + 10 = 479 ^ y is impossible.
-/
theorem diophantine1_9_10_479 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 479 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 480 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 480 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 10).
-/
theorem diophantine1_9_10_480 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 480 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Front Mode, no magic prime)   9 ^ x + 10 = 481 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 481 ^ y,
if y >= 1, 9 ^ x = 27 (mod 37).
However, this is impossible.
Therefore, y < 1.
So 9 ^ x + 10 = 481 ^ y is impossible.
-/
theorem diophantine1_9_10_481 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 481 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 481 ^ y, proof := h3},
    {prop := y <= 0, proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 482 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 482 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_482 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 482 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   9 ^ x + 10 = 483 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 483 ^ y,
if x >= 3 and y >= 3,
10 = 0 (mod 27), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 9 ^ x + 10 = 483 ^ y is impossible.
-/
theorem diophantine1_9_10_483 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 483 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 483 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 484 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 484 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_484 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 484 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 485 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 485 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 5).
-/
theorem diophantine1_9_10_485 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 485 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 486 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 486 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_486 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 486 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, no magic prime)   9 ^ x + 10 = 487 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 487 ^ y,
if x >= 3, 487 ^ y = 10 (mod 27).
However, this is impossible.
Therefore, x < 3.
Further examination shows that 9 ^ x + 10 = 487 ^ y is impossible.
-/
theorem diophantine1_9_10_487 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 487 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 487 ^ y, proof := h3},
    {prop := x <= 2, proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 488 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 488 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_488 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 488 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   9 ^ x + 10 = 489 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 489 ^ y,
if x >= 3 and y >= 3,
10 = 0 (mod 27), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 9 ^ x + 10 = 489 ^ y is impossible.
-/
theorem diophantine1_9_10_489 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 489 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 489 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 490 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 490 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 10).
-/
theorem diophantine1_9_10_490 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 490 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 37)   9 ^ x + 10 = 491 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 491 ^ y,
if x >= 3, 491 ^ y = 10 (mod 27).
So y = 12 (mod 18), 
which implies y = 0 (mod 3).
Therefore, 491 ^ y = 1 (mod 37).
So 9 ^ x = 28 (mod 37), but this is impossible.
Therefore, x < 3.
Further examination shows that 9 ^ x + 10 = 491 ^ y is impossible.
-/
theorem diophantine1_9_10_491 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 491 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h10 := Claim (List.Mem (491 ^ y % 37) [1]) [
    {prop := y % 1 = 0, proof := h5},
    {prop := y >= 1, proof := h2},
    {prop := y % 18 = 12, proof := h9},
  ] "utilize_mod_cycle"
  have h11 := Claim (List.Mem (9 ^ x % 37) [28]) [
    {prop := List.Mem (491 ^ y % 37) [1], proof := h10},
    {prop := 9 ^ x + 10 = 491 ^ y, proof := h3},
  ] "compute_mod_sub"
  have h12 := Claim False [
    {prop := x % 1 = 0, proof := h4},
    {prop := x >= 1, proof := h1},
...
/-
(Class I, Type i)   9 ^ x + 10 = 492 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 492 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_492 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 492 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Front Mode, no magic prime)   9 ^ x + 10 = 493 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 493 ^ y,
if y >= 1, 9 ^ x = 7 (mod 17).
However, this is impossible.
Therefore, y < 1.
So 9 ^ x + 10 = 493 ^ y is impossible.
-/
theorem diophantine1_9_10_493 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 493 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 9 ^ x + 10 = 493 ^ y, proof := h3},
    {prop := y <= 0, proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type i)   9 ^ x + 10 = 494 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 494 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_494 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 494 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 495 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 495 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 5).
-/
theorem diophantine1_9_10_495 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 495 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 496 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 496 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_496 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 496 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 37)   9 ^ x + 10 = 497 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 497 ^ y,
...
So 9 ^ x = 0 (mod 37), but this is impossible.
Therefore, x < 3.
Further examination shows that 9 ^ x + 10 = 497 ^ y is impossible.
-/
theorem diophantine1_9_10_497 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 497 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 498 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 498 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 2).
-/
theorem diophantine1_9_10_498 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 498 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
-- Succeeded.
/-
(Class II, Back Mode, with magic prime 109)   9 ^ x + 10 = 499 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 499 ^ y,
...
So 9 ^ x = 100 (mod 109), but this is impossible.
Therefore, x < 4.
Further examination shows that 9 ^ x + 10 = 499 ^ y is impossible.
-/
theorem diophantine1_9_10_499 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 499 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type i)   9 ^ x + 10 = 500 ^ y
For positive integers x, y satisfying 9 ^ x + 10 = 500 ^ y,
this is impossible, because it implies that 9 ^ x = 0 (mod 10).
-/
theorem diophantine1_9_10_500 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 9 ^ x + 10 = 500 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
