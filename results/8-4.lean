...
/-
(Class I, Type ii)   8 ^ x + 4 = 251 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 251 ^ y,
this is impossible, because it implies that 251 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_251 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 251 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 252 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 252 ^ y,
if x >= 2 and y >= 2,
4 = 0 (mod 16), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 8 ^ x + 4 = 252 ^ y is impossible.
-/
theorem diophantine1_8_4_252 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 252 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 252 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 253 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 253 ^ y,
this is impossible, because it implies that 253 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_253 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 253 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 254 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 254 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 254 ^ y is impossible.
-/
theorem diophantine1_8_4_254 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 254 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 254 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 255 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 255 ^ y,
this is impossible, because it implies that 255 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_255 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 255 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 256 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 256 ^ y,
if x >= 1 and y >= 1,
4 = 0 (mod 8), which is impossible.
Therefore, x < 1 or y < 1.
So 8 ^ x + 4 = 256 ^ y is impossible.
-/
theorem diophantine1_8_4_256 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 256 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 256 ^ y, proof := h3},
    {prop := Or (x <= 0) (y <= 0), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 257 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 257 ^ y,
this is impossible, because it implies that 257 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_257 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 257 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 258 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 258 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 258 ^ y is impossible.
-/
theorem diophantine1_8_4_258 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 258 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 258 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 259 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 259 ^ y,
this is impossible, because it implies that 259 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_259 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 259 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 260 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 260 ^ y,
if x >= 2 and y >= 2,
4 = 0 (mod 16), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 8 ^ x + 4 = 260 ^ y is impossible.
-/
theorem diophantine1_8_4_260 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 260 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 260 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 261 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 261 ^ y,
this is impossible, because it implies that 261 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_261 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 261 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 262 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 262 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 262 ^ y is impossible.
-/
theorem diophantine1_8_4_262 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 262 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 262 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 263 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 263 ^ y,
this is impossible, because it implies that 263 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_263 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 263 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 264 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 264 ^ y,
if x >= 1 and y >= 1,
4 = 0 (mod 8), which is impossible.
Therefore, x < 1 or y < 1.
So 8 ^ x + 4 = 264 ^ y is impossible.
-/
theorem diophantine1_8_4_264 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 264 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 264 ^ y, proof := h3},
    {prop := Or (x <= 0) (y <= 0), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 265 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 265 ^ y,
this is impossible, because it implies that 265 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_265 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 265 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 266 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 266 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 266 ^ y is impossible.
-/
theorem diophantine1_8_4_266 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 266 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 266 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 267 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 267 ^ y,
this is impossible, because it implies that 267 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_267 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 267 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 268 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 268 ^ y,
if x >= 2 and y >= 2,
4 = 0 (mod 16), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 8 ^ x + 4 = 268 ^ y is impossible.
-/
theorem diophantine1_8_4_268 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 268 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 268 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 269 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 269 ^ y,
this is impossible, because it implies that 269 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_269 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 269 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 270 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 270 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 270 ^ y is impossible.
-/
theorem diophantine1_8_4_270 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 270 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 270 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 271 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 271 ^ y,
this is impossible, because it implies that 271 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_271 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 271 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 272 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 272 ^ y,
if x >= 1 and y >= 1,
4 = 0 (mod 8), which is impossible.
Therefore, x < 1 or y < 1.
So 8 ^ x + 4 = 272 ^ y is impossible.
-/
theorem diophantine1_8_4_272 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 272 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 272 ^ y, proof := h3},
    {prop := Or (x <= 0) (y <= 0), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 273 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 273 ^ y,
this is impossible, because it implies that 273 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_273 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 273 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 274 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 274 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 274 ^ y is impossible.
-/
theorem diophantine1_8_4_274 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 274 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 274 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 275 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 275 ^ y,
this is impossible, because it implies that 275 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_275 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 275 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 276 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 276 ^ y,
if x >= 2 and y >= 2,
4 = 0 (mod 16), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 8 ^ x + 4 = 276 ^ y is impossible.
-/
theorem diophantine1_8_4_276 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 276 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 276 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 277 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 277 ^ y,
this is impossible, because it implies that 277 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_277 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 277 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 278 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 278 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 278 ^ y is impossible.
-/
theorem diophantine1_8_4_278 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 278 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 278 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 279 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 279 ^ y,
this is impossible, because it implies that 279 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_279 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 279 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 280 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 280 ^ y,
if x >= 1 and y >= 1,
4 = 0 (mod 8), which is impossible.
Therefore, x < 1 or y < 1.
So 8 ^ x + 4 = 280 ^ y is impossible.
-/
theorem diophantine1_8_4_280 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 280 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 280 ^ y, proof := h3},
    {prop := Or (x <= 0) (y <= 0), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 281 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 281 ^ y,
this is impossible, because it implies that 281 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_281 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 281 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 282 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 282 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 282 ^ y is impossible.
-/
theorem diophantine1_8_4_282 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 282 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 282 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 283 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 283 ^ y,
this is impossible, because it implies that 283 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_283 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 283 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 284 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 284 ^ y,
if x >= 2 and y >= 2,
4 = 0 (mod 16), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 8 ^ x + 4 = 284 ^ y is impossible.
-/
theorem diophantine1_8_4_284 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 284 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 284 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 285 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 285 ^ y,
this is impossible, because it implies that 285 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_285 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 285 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 286 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 286 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 286 ^ y is impossible.
-/
theorem diophantine1_8_4_286 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 286 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 286 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 287 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 287 ^ y,
this is impossible, because it implies that 287 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_287 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 287 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 288 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 288 ^ y,
if x >= 1 and y >= 1,
4 = 0 (mod 8), which is impossible.
Therefore, x < 1 or y < 1.
So 8 ^ x + 4 = 288 ^ y is impossible.
-/
theorem diophantine1_8_4_288 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 288 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 288 ^ y, proof := h3},
    {prop := Or (x <= 0) (y <= 0), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 289 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 289 ^ y,
this is impossible, because it implies that 289 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_289 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 289 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 290 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 290 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 290 ^ y is impossible.
-/
theorem diophantine1_8_4_290 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 290 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 290 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 291 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 291 ^ y,
this is impossible, because it implies that 291 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_291 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 291 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 292 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 292 ^ y,
if x >= 2 and y >= 2,
4 = 0 (mod 16), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 8 ^ x + 4 = 292 ^ y is impossible.
-/
theorem diophantine1_8_4_292 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 292 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 292 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 293 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 293 ^ y,
this is impossible, because it implies that 293 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_293 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 293 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 294 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 294 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 294 ^ y is impossible.
-/
theorem diophantine1_8_4_294 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 294 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 294 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 295 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 295 ^ y,
this is impossible, because it implies that 295 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_295 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 295 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 296 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 296 ^ y,
if x >= 1 and y >= 1,
4 = 0 (mod 8), which is impossible.
Therefore, x < 1 or y < 1.
So 8 ^ x + 4 = 296 ^ y is impossible.
-/
theorem diophantine1_8_4_296 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 296 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 296 ^ y, proof := h3},
    {prop := Or (x <= 0) (y <= 0), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 297 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 297 ^ y,
this is impossible, because it implies that 297 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_297 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 297 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 298 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 298 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 298 ^ y is impossible.
-/
theorem diophantine1_8_4_298 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 298 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 298 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 299 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 299 ^ y,
this is impossible, because it implies that 299 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_299 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 299 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 300 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 300 ^ y,
if x >= 2 and y >= 2,
4 = 0 (mod 16), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 8 ^ x + 4 = 300 ^ y is impossible.
-/
theorem diophantine1_8_4_300 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 300 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 300 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 301 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 301 ^ y,
this is impossible, because it implies that 301 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_301 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 301 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 302 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 302 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 302 ^ y is impossible.
-/
theorem diophantine1_8_4_302 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 302 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 302 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 303 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 303 ^ y,
this is impossible, because it implies that 303 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_303 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 303 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 304 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 304 ^ y,
if x >= 1 and y >= 1,
4 = 0 (mod 8), which is impossible.
Therefore, x < 1 or y < 1.
So 8 ^ x + 4 = 304 ^ y is impossible.
-/
theorem diophantine1_8_4_304 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 304 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 304 ^ y, proof := h3},
    {prop := Or (x <= 0) (y <= 0), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 305 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 305 ^ y,
this is impossible, because it implies that 305 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_305 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 305 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 306 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 306 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 306 ^ y is impossible.
-/
theorem diophantine1_8_4_306 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 306 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 306 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 307 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 307 ^ y,
this is impossible, because it implies that 307 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_307 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 307 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 308 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 308 ^ y,
if x >= 2 and y >= 2,
4 = 0 (mod 16), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 8 ^ x + 4 = 308 ^ y is impossible.
-/
theorem diophantine1_8_4_308 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 308 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 308 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 309 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 309 ^ y,
this is impossible, because it implies that 309 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_309 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 309 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 310 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 310 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 310 ^ y is impossible.
-/
theorem diophantine1_8_4_310 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 310 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 310 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 311 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 311 ^ y,
this is impossible, because it implies that 311 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_311 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 311 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 312 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 312 ^ y,
if x >= 1 and y >= 1,
4 = 0 (mod 8), which is impossible.
Therefore, x < 1 or y < 1.
So 8 ^ x + 4 = 312 ^ y is impossible.
-/
theorem diophantine1_8_4_312 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 312 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 312 ^ y, proof := h3},
    {prop := Or (x <= 0) (y <= 0), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 313 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 313 ^ y,
this is impossible, because it implies that 313 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_313 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 313 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 314 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 314 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 314 ^ y is impossible.
-/
theorem diophantine1_8_4_314 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 314 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 314 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 315 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 315 ^ y,
this is impossible, because it implies that 315 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_315 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 315 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 316 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 316 ^ y,
if x >= 2 and y >= 2,
4 = 0 (mod 16), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 8 ^ x + 4 = 316 ^ y is impossible.
-/
theorem diophantine1_8_4_316 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 316 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 316 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 317 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 317 ^ y,
this is impossible, because it implies that 317 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_317 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 317 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 318 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 318 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 318 ^ y is impossible.
-/
theorem diophantine1_8_4_318 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 318 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 318 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 319 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 319 ^ y,
this is impossible, because it implies that 319 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_319 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 319 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 320 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 320 ^ y,
if x >= 1 and y >= 1,
4 = 0 (mod 8), which is impossible.
Therefore, x < 1 or y < 1.
So 8 ^ x + 4 = 320 ^ y is impossible.
-/
theorem diophantine1_8_4_320 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 320 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 320 ^ y, proof := h3},
    {prop := Or (x <= 0) (y <= 0), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 321 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 321 ^ y,
this is impossible, because it implies that 321 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_321 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 321 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 322 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 322 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 322 ^ y is impossible.
-/
theorem diophantine1_8_4_322 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 322 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 322 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 323 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 323 ^ y,
this is impossible, because it implies that 323 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_323 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 323 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 324 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 324 ^ y,
if x >= 2 and y >= 2,
4 = 0 (mod 16), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 8 ^ x + 4 = 324 ^ y is impossible.
-/
theorem diophantine1_8_4_324 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 324 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 324 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 325 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 325 ^ y,
this is impossible, because it implies that 325 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_325 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 325 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 326 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 326 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 326 ^ y is impossible.
-/
theorem diophantine1_8_4_326 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 326 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 326 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 327 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 327 ^ y,
this is impossible, because it implies that 327 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_327 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 327 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 328 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 328 ^ y,
if x >= 1 and y >= 1,
4 = 0 (mod 8), which is impossible.
Therefore, x < 1 or y < 1.
So 8 ^ x + 4 = 328 ^ y is impossible.
-/
theorem diophantine1_8_4_328 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 328 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 328 ^ y, proof := h3},
    {prop := Or (x <= 0) (y <= 0), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 329 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 329 ^ y,
this is impossible, because it implies that 329 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_329 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 329 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 330 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 330 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 330 ^ y is impossible.
-/
theorem diophantine1_8_4_330 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 330 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 330 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 331 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 331 ^ y,
this is impossible, because it implies that 331 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_331 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 331 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 332 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 332 ^ y,
if x >= 2 and y >= 2,
4 = 0 (mod 16), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 8 ^ x + 4 = 332 ^ y is impossible.
-/
theorem diophantine1_8_4_332 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 332 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 332 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 333 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 333 ^ y,
this is impossible, because it implies that 333 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_333 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 333 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 334 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 334 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 334 ^ y is impossible.
-/
theorem diophantine1_8_4_334 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 334 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 334 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 335 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 335 ^ y,
this is impossible, because it implies that 335 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_335 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 335 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 336 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 336 ^ y,
if x >= 1 and y >= 1,
4 = 0 (mod 8), which is impossible.
Therefore, x < 1 or y < 1.
So 8 ^ x + 4 = 336 ^ y is impossible.
-/
theorem diophantine1_8_4_336 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 336 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 336 ^ y, proof := h3},
    {prop := Or (x <= 0) (y <= 0), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 337 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 337 ^ y,
this is impossible, because it implies that 337 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_337 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 337 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 338 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 338 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 338 ^ y is impossible.
-/
theorem diophantine1_8_4_338 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 338 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 338 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 339 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 339 ^ y,
this is impossible, because it implies that 339 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_339 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 339 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 340 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 340 ^ y,
if x >= 2 and y >= 2,
4 = 0 (mod 16), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 8 ^ x + 4 = 340 ^ y is impossible.
-/
theorem diophantine1_8_4_340 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 340 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 340 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 341 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 341 ^ y,
this is impossible, because it implies that 341 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_341 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 341 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 342 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 342 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 342 ^ y is impossible.
-/
theorem diophantine1_8_4_342 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 342 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 342 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 343 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 343 ^ y,
this is impossible, because it implies that 343 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_343 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 343 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 344 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 344 ^ y,
if x >= 1 and y >= 1,
4 = 0 (mod 8), which is impossible.
Therefore, x < 1 or y < 1.
So 8 ^ x + 4 = 344 ^ y is impossible.
-/
theorem diophantine1_8_4_344 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 344 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 344 ^ y, proof := h3},
    {prop := Or (x <= 0) (y <= 0), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 345 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 345 ^ y,
this is impossible, because it implies that 345 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_345 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 345 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 346 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 346 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 346 ^ y is impossible.
-/
theorem diophantine1_8_4_346 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 346 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 346 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 347 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 347 ^ y,
this is impossible, because it implies that 347 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_347 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 347 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 348 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 348 ^ y,
if x >= 2 and y >= 2,
4 = 0 (mod 16), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 8 ^ x + 4 = 348 ^ y is impossible.
-/
theorem diophantine1_8_4_348 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 348 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 348 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 349 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 349 ^ y,
this is impossible, because it implies that 349 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_349 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 349 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 350 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 350 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 350 ^ y is impossible.
-/
theorem diophantine1_8_4_350 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 350 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 350 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 351 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 351 ^ y,
this is impossible, because it implies that 351 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_351 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 351 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 352 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 352 ^ y,
if x >= 1 and y >= 1,
4 = 0 (mod 8), which is impossible.
Therefore, x < 1 or y < 1.
So 8 ^ x + 4 = 352 ^ y is impossible.
-/
theorem diophantine1_8_4_352 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 352 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 352 ^ y, proof := h3},
    {prop := Or (x <= 0) (y <= 0), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 353 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 353 ^ y,
this is impossible, because it implies that 353 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_353 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 353 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 354 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 354 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 354 ^ y is impossible.
-/
theorem diophantine1_8_4_354 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 354 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 354 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 355 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 355 ^ y,
this is impossible, because it implies that 355 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_355 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 355 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 356 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 356 ^ y,
if x >= 2 and y >= 2,
4 = 0 (mod 16), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 8 ^ x + 4 = 356 ^ y is impossible.
-/
theorem diophantine1_8_4_356 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 356 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 356 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 357 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 357 ^ y,
this is impossible, because it implies that 357 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_357 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 357 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 358 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 358 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 358 ^ y is impossible.
-/
theorem diophantine1_8_4_358 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 358 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 358 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 359 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 359 ^ y,
this is impossible, because it implies that 359 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_359 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 359 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 360 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 360 ^ y,
if x >= 1 and y >= 1,
4 = 0 (mod 8), which is impossible.
Therefore, x < 1 or y < 1.
So 8 ^ x + 4 = 360 ^ y is impossible.
-/
theorem diophantine1_8_4_360 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 360 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 360 ^ y, proof := h3},
    {prop := Or (x <= 0) (y <= 0), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 361 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 361 ^ y,
this is impossible, because it implies that 361 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_361 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 361 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 362 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 362 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 362 ^ y is impossible.
-/
theorem diophantine1_8_4_362 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 362 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 362 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 363 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 363 ^ y,
this is impossible, because it implies that 363 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_363 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 363 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 364 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 364 ^ y,
if x >= 2 and y >= 2,
4 = 0 (mod 16), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 8 ^ x + 4 = 364 ^ y is impossible.
-/
theorem diophantine1_8_4_364 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 364 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 364 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 365 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 365 ^ y,
this is impossible, because it implies that 365 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_365 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 365 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 366 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 366 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 366 ^ y is impossible.
-/
theorem diophantine1_8_4_366 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 366 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 366 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 367 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 367 ^ y,
this is impossible, because it implies that 367 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_367 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 367 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 368 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 368 ^ y,
if x >= 1 and y >= 1,
4 = 0 (mod 8), which is impossible.
Therefore, x < 1 or y < 1.
So 8 ^ x + 4 = 368 ^ y is impossible.
-/
theorem diophantine1_8_4_368 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 368 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 368 ^ y, proof := h3},
    {prop := Or (x <= 0) (y <= 0), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 369 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 369 ^ y,
this is impossible, because it implies that 369 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_369 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 369 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 370 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 370 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 370 ^ y is impossible.
-/
theorem diophantine1_8_4_370 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 370 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 370 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 371 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 371 ^ y,
this is impossible, because it implies that 371 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_371 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 371 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 372 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 372 ^ y,
if x >= 2 and y >= 2,
4 = 0 (mod 16), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 8 ^ x + 4 = 372 ^ y is impossible.
-/
theorem diophantine1_8_4_372 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 372 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 372 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 373 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 373 ^ y,
this is impossible, because it implies that 373 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_373 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 373 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 374 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 374 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 374 ^ y is impossible.
-/
theorem diophantine1_8_4_374 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 374 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 374 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 375 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 375 ^ y,
this is impossible, because it implies that 375 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_375 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 375 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 376 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 376 ^ y,
if x >= 1 and y >= 1,
4 = 0 (mod 8), which is impossible.
Therefore, x < 1 or y < 1.
So 8 ^ x + 4 = 376 ^ y is impossible.
-/
theorem diophantine1_8_4_376 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 376 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 376 ^ y, proof := h3},
    {prop := Or (x <= 0) (y <= 0), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 377 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 377 ^ y,
this is impossible, because it implies that 377 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_377 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 377 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 378 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 378 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 378 ^ y is impossible.
-/
theorem diophantine1_8_4_378 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 378 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 378 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 379 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 379 ^ y,
this is impossible, because it implies that 379 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_379 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 379 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 380 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 380 ^ y,
if x >= 2 and y >= 2,
4 = 0 (mod 16), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 8 ^ x + 4 = 380 ^ y is impossible.
-/
theorem diophantine1_8_4_380 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 380 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 380 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 381 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 381 ^ y,
this is impossible, because it implies that 381 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_381 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 381 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 382 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 382 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 382 ^ y is impossible.
-/
theorem diophantine1_8_4_382 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 382 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 382 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 383 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 383 ^ y,
this is impossible, because it implies that 383 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_383 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 383 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 384 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 384 ^ y,
if x >= 1 and y >= 1,
4 = 0 (mod 8), which is impossible.
Therefore, x < 1 or y < 1.
So 8 ^ x + 4 = 384 ^ y is impossible.
-/
theorem diophantine1_8_4_384 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 384 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 384 ^ y, proof := h3},
    {prop := Or (x <= 0) (y <= 0), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 385 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 385 ^ y,
this is impossible, because it implies that 385 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_385 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 385 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 386 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 386 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 386 ^ y is impossible.
-/
theorem diophantine1_8_4_386 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 386 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 386 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 387 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 387 ^ y,
this is impossible, because it implies that 387 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_387 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 387 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 388 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 388 ^ y,
if x >= 2 and y >= 2,
4 = 0 (mod 16), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 8 ^ x + 4 = 388 ^ y is impossible.
-/
theorem diophantine1_8_4_388 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 388 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 388 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 389 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 389 ^ y,
this is impossible, because it implies that 389 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_389 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 389 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 390 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 390 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 390 ^ y is impossible.
-/
theorem diophantine1_8_4_390 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 390 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 390 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 391 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 391 ^ y,
this is impossible, because it implies that 391 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_391 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 391 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 392 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 392 ^ y,
if x >= 1 and y >= 1,
4 = 0 (mod 8), which is impossible.
Therefore, x < 1 or y < 1.
So 8 ^ x + 4 = 392 ^ y is impossible.
-/
theorem diophantine1_8_4_392 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 392 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 392 ^ y, proof := h3},
    {prop := Or (x <= 0) (y <= 0), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 393 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 393 ^ y,
this is impossible, because it implies that 393 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_393 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 393 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 394 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 394 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 394 ^ y is impossible.
-/
theorem diophantine1_8_4_394 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 394 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 394 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 395 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 395 ^ y,
this is impossible, because it implies that 395 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_395 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 395 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 396 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 396 ^ y,
if x >= 2 and y >= 2,
4 = 0 (mod 16), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 8 ^ x + 4 = 396 ^ y is impossible.
-/
theorem diophantine1_8_4_396 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 396 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 396 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 397 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 397 ^ y,
this is impossible, because it implies that 397 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_397 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 397 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 398 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 398 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 398 ^ y is impossible.
-/
theorem diophantine1_8_4_398 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 398 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 398 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 399 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 399 ^ y,
this is impossible, because it implies that 399 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_399 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 399 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 400 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 400 ^ y,
if x >= 1 and y >= 1,
4 = 0 (mod 8), which is impossible.
Therefore, x < 1 or y < 1.
So 8 ^ x + 4 = 400 ^ y is impossible.
-/
theorem diophantine1_8_4_400 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 400 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 400 ^ y, proof := h3},
    {prop := Or (x <= 0) (y <= 0), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 401 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 401 ^ y,
this is impossible, because it implies that 401 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_401 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 401 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 402 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 402 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 402 ^ y is impossible.
-/
theorem diophantine1_8_4_402 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 402 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 402 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 403 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 403 ^ y,
this is impossible, because it implies that 403 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_403 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 403 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 404 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 404 ^ y,
if x >= 2 and y >= 2,
4 = 0 (mod 16), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 8 ^ x + 4 = 404 ^ y is impossible.
-/
theorem diophantine1_8_4_404 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 404 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 404 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 405 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 405 ^ y,
this is impossible, because it implies that 405 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_405 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 405 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 406 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 406 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 406 ^ y is impossible.
-/
theorem diophantine1_8_4_406 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 406 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 406 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 407 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 407 ^ y,
this is impossible, because it implies that 407 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_407 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 407 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 408 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 408 ^ y,
if x >= 1 and y >= 1,
4 = 0 (mod 8), which is impossible.
Therefore, x < 1 or y < 1.
So 8 ^ x + 4 = 408 ^ y is impossible.
-/
theorem diophantine1_8_4_408 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 408 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 408 ^ y, proof := h3},
    {prop := Or (x <= 0) (y <= 0), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 409 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 409 ^ y,
this is impossible, because it implies that 409 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_409 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 409 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 410 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 410 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 410 ^ y is impossible.
-/
theorem diophantine1_8_4_410 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 410 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 410 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 411 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 411 ^ y,
this is impossible, because it implies that 411 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_411 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 411 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 412 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 412 ^ y,
if x >= 2 and y >= 2,
4 = 0 (mod 16), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 8 ^ x + 4 = 412 ^ y is impossible.
-/
theorem diophantine1_8_4_412 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 412 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 412 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 413 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 413 ^ y,
this is impossible, because it implies that 413 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_413 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 413 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 414 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 414 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 414 ^ y is impossible.
-/
theorem diophantine1_8_4_414 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 414 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 414 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 415 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 415 ^ y,
this is impossible, because it implies that 415 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_415 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 415 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 416 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 416 ^ y,
if x >= 1 and y >= 1,
4 = 0 (mod 8), which is impossible.
Therefore, x < 1 or y < 1.
So 8 ^ x + 4 = 416 ^ y is impossible.
-/
theorem diophantine1_8_4_416 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 416 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 416 ^ y, proof := h3},
    {prop := Or (x <= 0) (y <= 0), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 417 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 417 ^ y,
this is impossible, because it implies that 417 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_417 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 417 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 418 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 418 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 418 ^ y is impossible.
-/
theorem diophantine1_8_4_418 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 418 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 418 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 419 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 419 ^ y,
this is impossible, because it implies that 419 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_419 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 419 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 420 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 420 ^ y,
if x >= 2 and y >= 2,
4 = 0 (mod 16), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 8 ^ x + 4 = 420 ^ y is impossible.
-/
theorem diophantine1_8_4_420 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 420 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 420 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 421 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 421 ^ y,
this is impossible, because it implies that 421 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_421 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 421 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 422 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 422 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 422 ^ y is impossible.
-/
theorem diophantine1_8_4_422 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 422 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 422 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 423 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 423 ^ y,
this is impossible, because it implies that 423 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_423 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 423 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 424 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 424 ^ y,
if x >= 1 and y >= 1,
4 = 0 (mod 8), which is impossible.
Therefore, x < 1 or y < 1.
So 8 ^ x + 4 = 424 ^ y is impossible.
-/
theorem diophantine1_8_4_424 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 424 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 424 ^ y, proof := h3},
    {prop := Or (x <= 0) (y <= 0), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 425 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 425 ^ y,
this is impossible, because it implies that 425 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_425 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 425 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 426 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 426 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 426 ^ y is impossible.
-/
theorem diophantine1_8_4_426 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 426 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 426 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 427 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 427 ^ y,
this is impossible, because it implies that 427 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_427 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 427 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 428 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 428 ^ y,
if x >= 2 and y >= 2,
4 = 0 (mod 16), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 8 ^ x + 4 = 428 ^ y is impossible.
-/
theorem diophantine1_8_4_428 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 428 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 428 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 429 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 429 ^ y,
this is impossible, because it implies that 429 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_429 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 429 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 430 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 430 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 430 ^ y is impossible.
-/
theorem diophantine1_8_4_430 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 430 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 430 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 431 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 431 ^ y,
this is impossible, because it implies that 431 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_431 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 431 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 432 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 432 ^ y,
if x >= 1 and y >= 1,
4 = 0 (mod 8), which is impossible.
Therefore, x < 1 or y < 1.
So 8 ^ x + 4 = 432 ^ y is impossible.
-/
theorem diophantine1_8_4_432 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 432 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 432 ^ y, proof := h3},
    {prop := Or (x <= 0) (y <= 0), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 433 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 433 ^ y,
this is impossible, because it implies that 433 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_433 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 433 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 434 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 434 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 434 ^ y is impossible.
-/
theorem diophantine1_8_4_434 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 434 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 434 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 435 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 435 ^ y,
this is impossible, because it implies that 435 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_435 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 435 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 436 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 436 ^ y,
if x >= 2 and y >= 2,
4 = 0 (mod 16), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 8 ^ x + 4 = 436 ^ y is impossible.
-/
theorem diophantine1_8_4_436 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 436 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 436 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 437 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 437 ^ y,
this is impossible, because it implies that 437 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_437 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 437 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 438 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 438 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 438 ^ y is impossible.
-/
theorem diophantine1_8_4_438 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 438 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 438 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 439 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 439 ^ y,
this is impossible, because it implies that 439 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_439 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 439 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 440 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 440 ^ y,
if x >= 1 and y >= 1,
4 = 0 (mod 8), which is impossible.
Therefore, x < 1 or y < 1.
So 8 ^ x + 4 = 440 ^ y is impossible.
-/
theorem diophantine1_8_4_440 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 440 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 440 ^ y, proof := h3},
    {prop := Or (x <= 0) (y <= 0), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 441 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 441 ^ y,
this is impossible, because it implies that 441 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_441 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 441 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 442 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 442 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 442 ^ y is impossible.
-/
theorem diophantine1_8_4_442 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 442 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 442 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 443 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 443 ^ y,
this is impossible, because it implies that 443 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_443 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 443 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 444 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 444 ^ y,
if x >= 2 and y >= 2,
4 = 0 (mod 16), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 8 ^ x + 4 = 444 ^ y is impossible.
-/
theorem diophantine1_8_4_444 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 444 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 444 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 445 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 445 ^ y,
this is impossible, because it implies that 445 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_445 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 445 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 446 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 446 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 446 ^ y is impossible.
-/
theorem diophantine1_8_4_446 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 446 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 446 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 447 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 447 ^ y,
this is impossible, because it implies that 447 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_447 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 447 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 448 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 448 ^ y,
if x >= 1 and y >= 1,
4 = 0 (mod 8), which is impossible.
Therefore, x < 1 or y < 1.
So 8 ^ x + 4 = 448 ^ y is impossible.
-/
theorem diophantine1_8_4_448 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 448 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 448 ^ y, proof := h3},
    {prop := Or (x <= 0) (y <= 0), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 449 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 449 ^ y,
this is impossible, because it implies that 449 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_449 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 449 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 450 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 450 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 450 ^ y is impossible.
-/
theorem diophantine1_8_4_450 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 450 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 450 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 451 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 451 ^ y,
this is impossible, because it implies that 451 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_451 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 451 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 452 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 452 ^ y,
if x >= 2 and y >= 2,
4 = 0 (mod 16), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 8 ^ x + 4 = 452 ^ y is impossible.
-/
theorem diophantine1_8_4_452 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 452 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 452 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 453 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 453 ^ y,
this is impossible, because it implies that 453 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_453 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 453 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 454 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 454 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 454 ^ y is impossible.
-/
theorem diophantine1_8_4_454 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 454 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 454 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 455 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 455 ^ y,
this is impossible, because it implies that 455 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_455 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 455 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 456 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 456 ^ y,
if x >= 1 and y >= 1,
4 = 0 (mod 8), which is impossible.
Therefore, x < 1 or y < 1.
So 8 ^ x + 4 = 456 ^ y is impossible.
-/
theorem diophantine1_8_4_456 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 456 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 456 ^ y, proof := h3},
    {prop := Or (x <= 0) (y <= 0), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 457 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 457 ^ y,
this is impossible, because it implies that 457 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_457 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 457 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 458 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 458 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 458 ^ y is impossible.
-/
theorem diophantine1_8_4_458 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 458 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 458 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 459 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 459 ^ y,
this is impossible, because it implies that 459 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_459 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 459 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 460 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 460 ^ y,
if x >= 2 and y >= 2,
4 = 0 (mod 16), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 8 ^ x + 4 = 460 ^ y is impossible.
-/
theorem diophantine1_8_4_460 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 460 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 460 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 461 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 461 ^ y,
this is impossible, because it implies that 461 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_461 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 461 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 462 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 462 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 462 ^ y is impossible.
-/
theorem diophantine1_8_4_462 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 462 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 462 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 463 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 463 ^ y,
this is impossible, because it implies that 463 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_463 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 463 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 464 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 464 ^ y,
if x >= 1 and y >= 1,
4 = 0 (mod 8), which is impossible.
Therefore, x < 1 or y < 1.
So 8 ^ x + 4 = 464 ^ y is impossible.
-/
theorem diophantine1_8_4_464 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 464 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 464 ^ y, proof := h3},
    {prop := Or (x <= 0) (y <= 0), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 465 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 465 ^ y,
this is impossible, because it implies that 465 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_465 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 465 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 466 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 466 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 466 ^ y is impossible.
-/
theorem diophantine1_8_4_466 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 466 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 466 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 467 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 467 ^ y,
this is impossible, because it implies that 467 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_467 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 467 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 468 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 468 ^ y,
if x >= 2 and y >= 2,
4 = 0 (mod 16), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 8 ^ x + 4 = 468 ^ y is impossible.
-/
theorem diophantine1_8_4_468 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 468 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 468 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 469 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 469 ^ y,
this is impossible, because it implies that 469 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_469 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 469 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 470 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 470 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 470 ^ y is impossible.
-/
theorem diophantine1_8_4_470 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 470 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 470 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 471 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 471 ^ y,
this is impossible, because it implies that 471 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_471 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 471 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 472 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 472 ^ y,
if x >= 1 and y >= 1,
4 = 0 (mod 8), which is impossible.
Therefore, x < 1 or y < 1.
So 8 ^ x + 4 = 472 ^ y is impossible.
-/
theorem diophantine1_8_4_472 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 472 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 472 ^ y, proof := h3},
    {prop := Or (x <= 0) (y <= 0), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 473 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 473 ^ y,
this is impossible, because it implies that 473 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_473 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 473 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 474 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 474 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 474 ^ y is impossible.
-/
theorem diophantine1_8_4_474 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 474 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 474 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 475 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 475 ^ y,
this is impossible, because it implies that 475 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_475 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 475 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 476 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 476 ^ y,
if x >= 2 and y >= 2,
4 = 0 (mod 16), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 8 ^ x + 4 = 476 ^ y is impossible.
-/
theorem diophantine1_8_4_476 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 476 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 476 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 477 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 477 ^ y,
this is impossible, because it implies that 477 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_477 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 477 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 478 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 478 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 478 ^ y is impossible.
-/
theorem diophantine1_8_4_478 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 478 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 478 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 479 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 479 ^ y,
this is impossible, because it implies that 479 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_479 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 479 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 480 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 480 ^ y,
if x >= 1 and y >= 1,
4 = 0 (mod 8), which is impossible.
Therefore, x < 1 or y < 1.
So 8 ^ x + 4 = 480 ^ y is impossible.
-/
theorem diophantine1_8_4_480 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 480 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 480 ^ y, proof := h3},
    {prop := Or (x <= 0) (y <= 0), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 481 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 481 ^ y,
this is impossible, because it implies that 481 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_481 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 481 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 482 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 482 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 482 ^ y is impossible.
-/
theorem diophantine1_8_4_482 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 482 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 482 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 483 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 483 ^ y,
this is impossible, because it implies that 483 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_483 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 483 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 484 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 484 ^ y,
if x >= 2 and y >= 2,
4 = 0 (mod 16), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 8 ^ x + 4 = 484 ^ y is impossible.
-/
theorem diophantine1_8_4_484 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 484 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 484 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 485 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 485 ^ y,
this is impossible, because it implies that 485 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_485 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 485 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 486 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 486 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 486 ^ y is impossible.
-/
theorem diophantine1_8_4_486 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 486 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 486 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 487 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 487 ^ y,
this is impossible, because it implies that 487 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_487 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 487 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 488 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 488 ^ y,
if x >= 1 and y >= 1,
4 = 0 (mod 8), which is impossible.
Therefore, x < 1 or y < 1.
So 8 ^ x + 4 = 488 ^ y is impossible.
-/
theorem diophantine1_8_4_488 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 488 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 488 ^ y, proof := h3},
    {prop := Or (x <= 0) (y <= 0), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 489 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 489 ^ y,
this is impossible, because it implies that 489 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_489 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 489 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 490 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 490 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 490 ^ y is impossible.
-/
theorem diophantine1_8_4_490 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 490 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 490 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 491 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 491 ^ y,
this is impossible, because it implies that 491 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_491 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 491 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 492 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 492 ^ y,
if x >= 2 and y >= 2,
4 = 0 (mod 16), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 8 ^ x + 4 = 492 ^ y is impossible.
-/
theorem diophantine1_8_4_492 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 492 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 492 ^ y, proof := h3},
    {prop := Or (x <= 1) (y <= 1), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 493 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 493 ^ y,
this is impossible, because it implies that 493 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_493 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 493 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 494 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 494 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 494 ^ y is impossible.
-/
theorem diophantine1_8_4_494 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 494 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 494 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 495 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 495 ^ y,
this is impossible, because it implies that 495 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_495 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 495 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 496 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 496 ^ y,
if x >= 1 and y >= 1,
4 = 0 (mod 8), which is impossible.
Therefore, x < 1 or y < 1.
So 8 ^ x + 4 = 496 ^ y is impossible.
-/
theorem diophantine1_8_4_496 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 496 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 496 ^ y, proof := h3},
    {prop := Or (x <= 0) (y <= 0), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 497 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 497 ^ y,
this is impossible, because it implies that 497 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_497 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 497 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 498 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 498 ^ y,
if x >= 3 and y >= 3,
4 = 0 (mod 8), which is impossible.
Therefore, x < 3 or y < 3.
Further examination shows that 8 ^ x + 4 = 498 ^ y is impossible.
-/
theorem diophantine1_8_4_498 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 498 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
  ...
  have h8 := Claim False [
    ...
    {prop :=  y % 1 = 0, proof := h5},
    {prop :=  y >= 1, proof := h2},
    {prop := 8 ^ x + 4 = 498 ^ y, proof := h3},
    {prop := Or (x <= 2) (y <= 2), proof := h7},
  ] "diophantine1_enumeration"
  exact h8

/-
(Class I, Type ii)   8 ^ x + 4 = 499 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 499 ^ y,
this is impossible, because it implies that 499 ^ y = 0 (mod 4).
-/
theorem diophantine1_8_4_499 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 499 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
...
/-
(Class I, Type iii)   8 ^ x + 4 = 500 ^ y
For positive integers x, y satisfying 8 ^ x + 4 = 500 ^ y,
if x >= 2 and y >= 2,
4 = 0 (mod 16), which is impossible.
Therefore, x < 2 or y < 2.
Further examination shows that 8 ^ x + 4 = 500 ^ y is impossible.
-/
theorem diophantine1_8_4_500 (x : Nat) (y : Nat) (h1 : x >= 1) (h2 : y >= 1) (h3 : 8 ^ x + 4 = 500 ^ y) :
  False
  := by
  have h4 : x % 1 = 0 := by omega
  have h5 : y % 1 = 0 := by omega
